...
(function () {
  ...
  function k(Z) {
    ...
    function ab(ah) {
            SRTlib.send(`{ "anonymous": false, "function": "ab", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
    ...
    function X(am) {
            SRTlib.send(`{ "anonymous": false, "function": "X", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
          ...
          if (ag.length >= 2 && ai === "[") {
            ...
            if (ai !== "\\") {
              aj[ak] = ag.replace(/[a-zA-Z]/g, function (ao) {
                                SRTlib.send(`{ "anonymous": true, "function": "aj.ak", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);

                var ap = ao.charCodeAt(0);
                                SRTlib.send('], "end": "aj.ak"},');
  ...
  function a(V) {
    ...
    function aa(ab) {
            SRTlib.send(`{ "anonymous": false, "function": "aa", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
  ...
  function Q(V, ag) {
    ...
    function ad(ak) {
            SRTlib.send(`{ "anonymous": false, "function": "ad", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
      ...
      function ai(al, ar) {
                SRTlib.send(`{ "anonymous": false, "function": "ai", "fileName": "${__filename}", "paramsNumber": 2, "calls" : [`);
  ...
  function b(ad) {
    ...
    if (!W.now) {
      W = {
        now: function () {
                    SRTlib.send(`{ "anonymous": true, "function": "W.now", "fileName": "${__filename}", "paramsNumber": 0, "calls" : [`);

                    SRTlib.send('], "end": "W.now"},');
