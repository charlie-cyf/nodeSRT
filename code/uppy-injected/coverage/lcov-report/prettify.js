...
(function () {
  ...
  function k(Z) {
    ...
    function ab(ah) {
            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"ab","fileName":"${__filename}","paramsNumber":1},`);

      var ag = ah.charCodeAt(0);
      if (ag !== 92) {
                SRTlib.send('{"type":"FUNCTIONEND","function":"ab"},');
      ...
      if (ag) {
        ...
        if ("0" <= af && af <= "7") {
          ...
          if (af === "u" || af === "x") {
            ...
            SRTlib.send('{"type":"FUNCTIONEND","function":"ab","paramsNumber":1},');
    ...
    function X(am) {
            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"X","fileName":"${__filename}","paramsNumber":1},`);
      ...
      af.sort(function (av, au) {
                SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"af.sort","fileName":"${__filename}","paramsNumber":2},`);

                SRTlib.send('{"type":"FUNCTIONEND","function":"af.sort"},');
      ...
      return an.join("");
            SRTlib.send('{"type":"FUNCTIONEND","function":"X","paramsNumber":1},');
    ...
    function W(al) {
          ...
          if (ag.length >= 2 && ai === "[") {
            ...
            if (ai !== "\\") {
              aj[ak] = ag.replace(/[a-zA-Z]/g, function (ao) {
                                SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"aj.ak.ag.replace","fileName":"${__filename}","paramsNumber":1},`);

                var ap = ao.charCodeAt(0);
                                SRTlib.send('{"type":"FUNCTIONEND","function":"aj.ak.ag.replace"},');
      ...
      return aj.join("");
            SRTlib.send('{"type":"FUNCTIONEND","function":"W","paramsNumber":1},');
  ...
  function a(V) {
    ...
    function aa(ab) {
            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"aa","fileName":"${__filename}","paramsNumber":1},`);

      switch (ab.nodeType) {
        case 1:
          if (U.test(ab.className)) {
                        SRTlib.send('{"type":"FUNCTIONEND","function":"aa"},');
        ...
        case 4:
          ...
          break;
            ...
            SRTlib.send('{"type":"FUNCTIONEND","function":"aa","paramsNumber":1},');
  ...
  function B(S, U, W, T) {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"B","fileName":"${__filename}","paramsNumber":4},`);
    ...
    T.push.apply(T, V.decorations);
        SRTlib.send('{"type":"FUNCTIONEND","function":"B","paramsNumber":4},');
  ...
  function g(U, T) {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"g","fileName":"${__filename}","paramsNumber":2},`);
    ...
    return W;
        SRTlib.send('{"type":"FUNCTIONEND","function":"g","paramsNumber":2},');
  ...
  function Q(V, ag) {
    ...
    var W = [af];
    function ae(al) {
            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"ae","fileName":"${__filename}","paramsNumber":1},`);
      ...
      switch (al.nodeType) {
        ...
        case 4:
          ...
          break;
            ...
            SRTlib.send('{"type":"FUNCTIONEND","function":"ae","paramsNumber":1},');

    }
    function ad(ak) {
            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"ad","fileName":"${__filename}","paramsNumber":1},`);

      while (!ak.nextSibling) {
        ak = ak.parentNode;
        if (!ak) {
                    SRTlib.send('{"type":"FUNCTIONEND","function":"ad"},');

          return;
        }
      }
      function ai(al, ar) {
                SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"ai","fileName":"${__filename}","paramsNumber":2},`);
        ...
        if (ao) {
          ...
          for (var am = an; am; am = an) {
            ...
            ap.appendChild(am);
                ...
                SRTlib.send('{"type":"FUNCTIONEND","function":"ai"},');

        return aq;
                SRTlib.send('{"type":"FUNCTIONEND","function":"ai","paramsNumber":2},');
      ...
      W.push(ah);
            SRTlib.send('{"type":"FUNCTIONEND","function":"ad","paramsNumber":1},');
  ...
  function c(U, V) {
    ...
    for (var S = V.length; --S >= 0; ) {
      ...
      if (!t.hasOwnProperty(T)) {
        ...
        SRTlib.send('{"type":"FUNCTIONEND","function":"c","paramsNumber":2},');
  ...
  function y(W, V, U) {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"y","fileName":"${__filename}","paramsNumber":3},`);
    ...
    return S.innerHTML;
        SRTlib.send('{"type":"FUNCTIONEND","function":"y","paramsNumber":3},');
  ...
  function b(ad) {
    ...
    function Y(af) {
      ...
      return document.getElementsByTagName(af);
            SRTlib.send('{"type":"FUNCTIONEND","function":"Y","paramsNumber":1},');
    ...
    if (!W.now) {
      W = {
        now: function () {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"W.now","fileName":"${__filename}","paramsNumber":0},`);

                    SRTlib.send('{"type":"FUNCTIONEND","function":"W.now"},');
    ...
    function U() {
            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"U","fileName":"${__filename}","paramsNumber":0},`);
      ...
      if (X < T.length) {
        ...
        if (ad) {
          ad();
            ...
            SRTlib.send('{"type":"FUNCTIONEND","function":"U","paramsNumber":0},');

    }
    U();
        SRTlib.send('{"type":"FUNCTIONEND","function":"b","paramsNumber":1},');
