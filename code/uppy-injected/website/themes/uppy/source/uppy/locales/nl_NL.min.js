...
!(function () {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"emptyKey","fileName":"/website/themes/uppy/source/uppy/locales/nl_NL.min.js","paramsNumber":0},`);
  ...
  var e = {
    strings: {
      ...
      creatingAssemblyFailed: "Transloadit: Kon Assembly niet cre\xeberen",
      ...
      filesUploadedOfTotal: {
        0: "%{complete} van %{smart_count} bestand ge\xfcpload",
        1: "%{complete} van %{smart_count} bestanden ge\xfcpload"
      },
      filter: "Filter",
    ...
    pluralize: function (e) {
            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"e.pluralize","fileName":"/website/themes/uppy/source/uppy/locales/nl_NL.min.js","paramsNumber":1},`);
  ...
  "undefined" != typeof window && void 0 !== window.Uppy && (window.Uppy.locales.nl_NL = e);
