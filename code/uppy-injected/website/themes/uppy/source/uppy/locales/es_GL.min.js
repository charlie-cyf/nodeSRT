...
!(function () {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"emptyKey","fileName":"/website/themes/uppy/source/uppy/locales/es_GL.min.js","paramsNumber":0},`);

  var a = {
    strings: {
      addMore: "a\xf1adir m\xe1s",
      addMoreFiles: "Agregar m\xe1is arquivos",
      addingMoreFiles: "Agregando m\xe1is arquivos",
      allowAccessDescription: "Para tomar fotos ou grabar video coa t\xfaa c\xe1mara, por favor permite a este sitio o acceso \xe1 c\xe1mara.",
      allowAccessTitle: "Por favor permite o acceso \xe1 tua c\xe1mara",
      authenticateWith: "Conectar a %{pluginName}",
      authenticateWithTitle: "Por favor autent\xedcate con %{pluginName} para seleccionar arquivos",
      back: "Atr\xe1s",
      browse: "navegar",
      cancel: "Cancelar",
      ...
      companionError: "Conexi\xf3n con Companion fallou",
      complete: "Completado",
      ...
      dropHereOr: "Soltar arquivos aqu\xed ou %{browse}",
      dropHint: "Solta os teus arqivos aqu\xed",
      dropPaste: "Soltar arquivos aqu\xed, pegar ou %{browse}",
      dropPasteImport: "Soltar arquivos aqu\xed, pegar, %{browse} ou importar dende",
      editFile: "Editar arquivo",
      editing: "Editando %{file}",
      emptyFolderAdded: "Ning\xfan arquivo foi agregado dende o cartafol vac\xeda",
      encoding: "Codificando...",
      enterCorrectUrl: "URL incorrecta: Por favor aseg\xfarate que est\xe1s ingresando un enlace a un arquivo",
      enterUrlToImport: "Ingresa unha URL para importar un arquivo",
      exceedsSize: "Este arquivo excede el tama\xf1o m\xe1ximo de",
      failedToFetch: "Companion non puido recuperar esta URL, por favor aseg\xfarate que sexa correcta",
      ...
      filter: "Filtrar",
      finishEditingFile: "Rematar edici\xf3n de arquivo",
      folderAdded: {
      ...
      loading: "Cargando...",
      logOut: "Pechar sesi\xf3n",
      myDevice: "O meu Dispositivo",
      noFilesFound: "Non existen arquivos ou cartafol aqu\xed",
      ...
      smile: "Sorr\xed!",
      startRecording: "Comezar a grabaci\xf3n de v\xeddeo",
      stopRecording: "Detener la grabaci\xf3n de v\xeddeo",
      ...
      xMoreFilesAdded: {
        0: "%{smart_count} arquivo m\xe1is agregado",
        1: "%{smart_count} arquivos m\xe1is agregados",
        2: "%{smart_count} arquivos m\xe1is agregados"
      },
    ...
    pluralize: function (a) {
            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"a.pluralize","fileName":"/website/themes/uppy/source/uppy/locales/es_GL.min.js","paramsNumber":1},`);
  ...
  "undefined" != typeof window && void 0 !== window.Uppy && (window.Uppy.locales.gl_ES = a);
