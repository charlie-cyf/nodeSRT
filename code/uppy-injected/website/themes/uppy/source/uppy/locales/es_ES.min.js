...
!(function () {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"emptyKey","fileName":"/website/themes/uppy/source/uppy/locales/es_ES.min.js","paramsNumber":0},`);

  var a = {
    strings: {
      addMoreFiles: "Agregar m\xe1s archivos",
      addingMoreFiles: "Agregando m\xe1s archivos",
      allowAccessDescription: "Para tomar fotos o grabar video con tu c\xe1mara, por favor permite a este sitio el acceso a la c\xe1mara.",
      allowAccessTitle: "Por favor permite el acceso a tu c\xe1mara",
      authenticateWith: "Conectar a %{pluginName}",
      authenticateWithTitle: "Por favor autent\xedcate con %{pluginName} para seleccionar archivos",
      back: "Atr\xe1s",
      addMore: "Agregar m\xe1s",
      browse: "navegar",
      cancel: "Cancelar",
      cancelUpload: "Cancelar subida",
      chooseFiles: "Seleccionar archivos",
      closeModal: "Cerrar ventana flotante",
      companionError: "Conexi\xf3n con Companion fall\xf3",
      complete: "Completado",
      ...
      dropHereOr: "Soltar archivos aqu\xed o %{browse}",
      dropHint: "Suelta tus archivos aqu\xed",
      dropPaste: "Soltar archivos aqu\xed, pegar o %{browse}",
      dropPasteImport: "Soltar archivos aqu\xed, pegar, %{browse} o importar desde",
      editFile: "Editar archivo",
      editing: "Editando %{file}",
      emptyFolderAdded: "Ning\xfan archivo fue agregado desde la carpeta vac\xeda",
      encoding: "Codificando...",
      enterCorrectUrl: "URL incorrecta: Por favor aseg\xfarate que est\xe1s ingresando un enlace a un archivo",
      enterUrlToImport: "Ingresa una URL para importar un archivo",
      exceedsSize: "Este archivo excede el tama\xf1o m\xe1ximo de",
      failedToFetch: "Companion no ha podido recuperar esta URL, por favor aseg\xfarate que sea correcta",
      ...
      filter: "Filtrar",
      finishEditingFile: "Terminar edici\xf3n de archivo",
      folderAdded: {
      ...
      noFilesFound: "No existen archivos o carpetas aqu\xed",
      noInternetConnection: "Sin conexi\xf3n a Internet",
      pause: "Pausar",
      ...
      recordingLength: "Duraci\xf3n de grabaci\xf3n %{recording_length}",
      ...
      smile: "Sonr\xede!",
      startRecording: "Comenzar la grabaci\xf3n de video",
      stopRecording: "Detener la grabaci\xf3n de video",
      takePicture: "Tomar una foto",
      timedOut: "Subida estancada por %{seconds} segundos, anulando.",
      upload: "Subir",
      uploadComplete: "Subida terminada",
      uploadFailed: "Subida fall\xf3",
      ...
      xMoreFilesAdded: {
        0: "%{smart_count} archivo m\xe1s agregado",
        1: "%{smart_count} archivos m\xe1s agregados",
        2: "%{smart_count} archivos m\xe1s agregados"
      },
    ...
    pluralize: function (a) {
            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"a.pluralize","fileName":"/website/themes/uppy/source/uppy/locales/es_ES.min.js","paramsNumber":1},`);
  ...
  "undefined" != typeof window && void 0 !== window.Uppy && (window.Uppy.locales.es_ES = a);
