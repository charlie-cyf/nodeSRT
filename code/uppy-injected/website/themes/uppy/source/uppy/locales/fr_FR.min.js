...
!(function () {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"emptyKey","fileName":"/website/themes/uppy/source/uppy/locales/fr_FR.min.js","paramsNumber":0},`);

  var e = {
    strings: {
      addBulkFilesFailed: {
        0: "L'ajout de %{smart_count} fichier a \xe9chou\xe9",
        1: "L'ajout de %{smart_count} fichiers a \xe9chou\xe9"
      },
      ...
      dropHereOr: "D\xe9poser les fichiers ici ou %{browse}",
      dropHint: "D\xe9posez vos fichiers ici",
      dropPaste: "D\xe9poser les fichiers ici, coller ou %{browse}",
      ...
      filesUploadedOfTotal: {
        0: "%{complete} sur %{smart_count} fichier t\xe9l\xe9charg\xe9",
        1: "%{complete} sur %{smart_count} fichiers t\xe9l\xe9charg\xe9s",
        2: "%{complete} sur %{smart_count} fichiers t\xe9l\xe9charg\xe9s"
      },
      filter: "Filtrer",
      finishEditingFile: "Terminer l'\xe9dition du fichier",
      folderAdded: {
        0: "%{smart_count} fichier ajout\xe9 de %{folder}",
        1: "%{smart_count} fichiers ajout\xe9s de %{folder}",
        2: "%{smart_count} fichiers ajout\xe9s de %{folder}"
      },
      ...
      selectX: {
        0: "S\xe9lectionner %{smart_count}",
        1: "S\xe9lectionner %{smart_count}",
        2: "S\xe9lectionner %{smart_count}"
      },
      smile: "Souriez !",
      ...
      uploadXFiles: {
        0: "T\xe9l\xe9charger %{smart_count} fichier",
        1: "T\xe9l\xe9charger %{smart_count} fichiers",
        2: "T\xe9l\xe9charger %{smart_count} fichiers"
      },
      uploadXNewFiles: {
        0: "T\xe9l\xe9charger +%{smart_count} fichier",
        1: "T\xe9l\xe9charger +%{smart_count} fichiers",
      ...
      xFilesSelected: {
        0: "%{smart_count} fichier s\xe9lectionn\xe9",
        1: "%{smart_count} fichiers s\xe9lectionn\xe9s",
        2: "%{smart_count} fichiers s\xe9lectionn\xe9s"
      },
      xMoreFilesAdded: {
        0: "%{smart_count} autre fichier ajout\xe9",
        1: "%{smart_count} autres fichiers ajout\xe9s",
        2: "%{smart_count} autres fichiers ajout\xe9s"
      },
      ...
      youHaveToAtLeastSelectX: {
        0: "Vous devez s\xe9lectionner au moins %{smart_count} fichier",
        1: "Vous devez s\xe9lectionner au moins %{smart_count} fichiers",
        2: "Vous devez s\xe9lectionner au moins %{smart_count} fichiers"
      }
    },
    pluralize: function (e) {
            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"e.pluralize","fileName":"/website/themes/uppy/source/uppy/locales/fr_FR.min.js","paramsNumber":1},`);
