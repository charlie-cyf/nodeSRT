...
!(function () {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"emptyKey","fileName":"/website/themes/uppy/source/uppy/locales/pt_BR.min.js","paramsNumber":0},`);
  ...
  var o = {
    strings: {
      ...
      exceedsSize: "Esse arquivo excedeu o tamanho m\xe1ximo permitido",
      failedToFetch: "Servi\xe7o falgou para buscar essa URL, por favor tenha certeza que a URL est\xe1 correta",
      ...
      youCanOnlyUploadFileTypes: "Voc\xea pode enviar apenas aquivos: %{types}",
      youCanOnlyUploadX: {
        0: "Voc\xea pode enviar apenas %{smart_count} arquivo",
        1: "Voc\xea pode enviar apenas %{smart_count} arquivos",
        2: "Voc\xea pode enviar apenas %{smart_count} arquivos"
      },
      youHaveToAtLeastSelectX: {
        ...
        2: "Voc\xea precisa selecionar pelo menos %{smart_count} arquivos"
      },
    ...
    pluralize: function (o) {
            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"o.pluralize","fileName":"/website/themes/uppy/source/uppy/locales/pt_BR.min.js","paramsNumber":1},`);
  ...
  "undefined" != typeof window && void 0 !== window.Uppy && (window.Uppy.locales.pt_BR = o);
