...
(function () {
  ...
  7: [function (require, module, exports) {
    ...
    module.exports = function extend() {
            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.extend","fileName":"${__filename}","paramsNumber":0},`);
      ...
      for (; i < length; ++i) {
        ...
        if (options != null) {
          for (name in options) {
            ...
            SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports.extend"},');
      ...
      (function (global, factory) {
        ...
        var encode = function (u, urisafe) {
          ...
          return !urisafe ? _encode(u) : _encode(String(u)).replace(/[+\/]/g, function (m0) {
                        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"call.encode.ReturnStatement.replace.replace.replace","fileName":"${__filename}","paramsNumber":1},`);

                        SRTlib.send('{"type":"FUNCTIONEND","function":"call.encode.ReturnStatement.replace.replace.replace"},');
        ...
        var decode = function (a) {
          ...
          return _decode(String(a).replace(/[-_]/g, function (m0) {
                        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"call.decode.ReturnStatement._decode.replace.replace.replace","fileName":"${__filename}","paramsNumber":1},`);

                        SRTlib.send('{"type":"FUNCTIONEND","function":"call.decode.ReturnStatement._decode.replace.replace.replace"},');
        ...
        if (typeof Object.defineProperty === 'function') {
          ...
          global.Base64.extendString = function () {
            ...
            Object.defineProperty(String.prototype, 'fromBase64', noEnum(function () {
                            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"call.global.Base64.extendString.noEnum","fileName":"${__filename}","paramsNumber":0},`);

                            SRTlib.send('{"type":"FUNCTIONEND","function":"call.global.Base64.extendString.noEnum"},');
            ...
            Object.defineProperty(String.prototype, 'toBase64', noEnum(function (urisafe) {
                            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"call.global.Base64.extendString.noEnum2","fileName":"${__filename}","paramsNumber":1},`);

                            SRTlib.send('{"type":"FUNCTIONEND","function":"call.global.Base64.extendString.noEnum2"},');
            ...
            Object.defineProperty(String.prototype, 'toBase64URI', noEnum(function () {
                            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"call.global.Base64.extendString.noEnum3","fileName":"${__filename}","paramsNumber":0},`);

                            SRTlib.send('{"type":"FUNCTIONEND","function":"call.global.Base64.extendString.noEnum3"},');
  ...
  15: [function (require, module, exports) {
    ...
    module.exports = function required(port, protocol) {
            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.required","fileName":"${__filename}","paramsNumber":2},`);

      protocol = protocol.split(':')[0];
      port = +port;
      if (!port) {
                SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports.required"},');
  ...
  21: [function (require, module, exports) {
    ...
    var FileSource = (function () {
      ...
      _createClass(FileSource, [{
        ...
        value: function slice(start, end, callback) {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"FileSource._createClass.value.slice2","fileName":"${__filename}","paramsNumber":3},`);
          ...
          if ((0, _isCordova2.default)()) {
            (0, _readAsByteArray2.default)(this._file.slice(start, end), function (err, chunk) {
              ...
              callback(null, chunk);
                        ...
                        SRTlib.send('{"type":"FUNCTIONEND","function":"FileSource._createClass.value.slice2"},');
        ...
        value: function close() {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"FileSource._createClass.value.close","fileName":"${__filename}","paramsNumber":0},`);

                    SRTlib.send('{"type":"FUNCTIONEND","function":"FileSource._createClass.value.close"},');
    ...
    var StreamSource = (function () {
      ...
      _createClass(StreamSource, [{
        key: "slice",
        value: function slice(start, end, callback) {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"StreamSource._createClass.value.slice","fileName":"${__filename}","paramsNumber":3},`);

          if (start < this._bufferOffset) {
            callback(new Error("Requested data is before the reader's current offset"));
                        SRTlib.send('{"type":"FUNCTIONEND","function":"StreamSource._createClass.value.slice"},');
        ...
        value: function _readUntilEnoughDataOrDone(start, end, callback) {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"StreamSource._createClass.value._readUntilEnoughDataOrDone","fileName":"${__filename}","paramsNumber":3},`);
          ...
          if (this._done || hasEnoughData) {
            ...
            callback(null, value, value == null ? this._done : false);
                        SRTlib.send('{"type":"FUNCTIONEND","function":"StreamSource._createClass.value._readUntilEnoughDataOrDone"},');
        ...
        value: function _getDataFromBuffer(start, end) {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"StreamSource._createClass.value._getDataFromBuffer","fileName":"${__filename}","paramsNumber":2},`);
          ...
          if (this._done && hasAllDataBeenRead) {
                        SRTlib.send('{"type":"FUNCTIONEND","function":"StreamSource._createClass.value._getDataFromBuffer"},');
        ...
        key: "close",
        value: function close() {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"StreamSource._createClass.value.close","fileName":"${__filename}","paramsNumber":0},`);

          if (this._reader.cancel) {
            this._reader.cancel();
          }
                    SRTlib.send('{"type":"FUNCTIONEND","function":"StreamSource._createClass.value.close"},');
    ...
    var LocalStorage = (function () {
      ...
      _createClass(LocalStorage, [{
        ...
        value: function setItem(key, value, cb) {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"LocalStorage._createClass.value.setItem","fileName":"${__filename}","paramsNumber":3},`);

          cb(null, localStorage.setItem(key, value));
                    SRTlib.send('{"type":"FUNCTIONEND","function":"LocalStorage._createClass.value.setItem"},');

        }
      }, {
        key: "getItem",
        value: function getItem(key, cb) {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"LocalStorage._createClass.value.getItem","fileName":"${__filename}","paramsNumber":2},`);

          cb(null, localStorage.getItem(key));
                    SRTlib.send('{"type":"FUNCTIONEND","function":"LocalStorage._createClass.value.getItem"},');

        }
      }, {
        key: "removeItem",
        value: function removeItem(key, cb) {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"LocalStorage._createClass.value.removeItem","fileName":"${__filename}","paramsNumber":2},`);

          cb(null, localStorage.removeItem(key));
                    SRTlib.send('{"type":"FUNCTIONEND","function":"LocalStorage._createClass.value.removeItem"},');
    ...
    var Upload = (function () {
      ...
      _createClass(Upload, [{
        ...
        value: function start() {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"Upload._createClass.value.start","fileName":"${__filename}","paramsNumber":0},`);

          var _this = this;
          var file = this.file;
          if (!file) {
            this._emitError(new Error("tus: no file or stream to upload provided"));
                        SRTlib.send('{"type":"FUNCTIONEND","function":"Upload._createClass.value.start"},');
        ...
        value: function _start(source) {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"Upload._createClass.value._start","fileName":"${__filename}","paramsNumber":1},`);
          ...
          if (this.options.uploadLengthDeferred) {
            ...
            if (isNaN(this._size)) {
              this._emitError(new Error("tus: cannot convert `uploadSize` option into a number"));
                            SRTlib.send('{"type":"FUNCTIONEND","function":"Upload._createClass.value._start"},');
        ...
        value: function abort(shouldTerminate, cb) {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"Upload._createClass.value.abort2","fileName":"${__filename}","paramsNumber":2},`);
          ...
          if (shouldTerminate) {
            Upload.terminate(this.url, this.options, function (err, xhr) {
                            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"Upload._createClass.value.abort","fileName":"${__filename}","paramsNumber":2},`);

              if (err) {
                                SRTlib.send('{"type":"FUNCTIONEND","function":"Upload._createClass.value.abort"},');
            ...
            cb();
                    ...
                    SRTlib.send('{"type":"FUNCTIONEND","function":"Upload._createClass.value.abort2"},');

        }
      }, {
        key: "_hasStorage",
        value: function _hasStorage() {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"Upload._createClass.value._hasStorage","fileName":"${__filename}","paramsNumber":0},`);

                    SRTlib.send('{"type":"FUNCTIONEND","function":"Upload._createClass.value._hasStorage"},');
        ...
        value: function _emitXhrError(xhr, err, causingErr) {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"Upload._createClass.value._emitXhrError","fileName":"${__filename}","paramsNumber":3},`);

          this._emitError(new _error2.default(err, causingErr, xhr));
                    SRTlib.send('{"type":"FUNCTIONEND","function":"Upload._createClass.value._emitXhrError"},');

        }
      }, {
        key: "_emitError",
        value: function _emitError(err) {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"Upload._createClass.value._emitError","fileName":"${__filename}","paramsNumber":1},`);

          if (typeof this.options.onError === "function") {
            this.options.onError(err);
          } else {
                        SRTlib.send('{"type":"FUNCTIONEND","function":"Upload._createClass.value._emitError"},');
        ...
        value: function _emitSuccess() {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"Upload._createClass.value._emitSuccess","fileName":"${__filename}","paramsNumber":0},`);

          if (typeof this.options.onSuccess === "function") {
            this.options.onSuccess();
          }
                    SRTlib.send('{"type":"FUNCTIONEND","function":"Upload._createClass.value._emitSuccess"},');

        }
      }, {
        key: "_emitProgress",
        value: function _emitProgress(bytesSent, bytesTotal) {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"Upload._createClass.value._emitProgress","fileName":"${__filename}","paramsNumber":2},`);

          if (typeof this.options.onProgress === "function") {
            this.options.onProgress(bytesSent, bytesTotal);
          }
                    SRTlib.send('{"type":"FUNCTIONEND","function":"Upload._createClass.value._emitProgress"},');

        }
      }, {
        key: "_emitChunkComplete",
        value: function _emitChunkComplete(chunkSize, bytesAccepted, bytesTotal) {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"Upload._createClass.value._emitChunkComplete","fileName":"${__filename}","paramsNumber":3},`);

          if (typeof this.options.onChunkComplete === "function") {
            this.options.onChunkComplete(chunkSize, bytesAccepted, bytesTotal);
          }
                    SRTlib.send('{"type":"FUNCTIONEND","function":"Upload._createClass.value._emitChunkComplete"},');

        }
      }, {
        key: "_setupXHR",
        value: function _setupXHR(xhr) {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"Upload._createClass.value._setupXHR","fileName":"${__filename}","paramsNumber":1},`);

          this._xhr = xhr;
          setupXHR(xhr, this.options);
                    SRTlib.send('{"type":"FUNCTIONEND","function":"Upload._createClass.value._setupXHR"},');

        }
      }, {
        key: "_createUpload",
        value: function _createUpload() {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"Upload._createClass.value._createUpload","fileName":"${__filename}","paramsNumber":0},`);

          var _this4 = this;
          if (!this.options.endpoint) {
            this._emitError(new Error("tus: unable to create upload because no endpoint is provided"));
                        SRTlib.send('{"type":"FUNCTIONEND","function":"Upload._createClass.value._createUpload"},');
        ...
        value: function _resumeUpload() {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"Upload._createClass.value._resumeUpload","fileName":"${__filename}","paramsNumber":0},`);
          ...
          this._setupXHR(xhr);
          xhr.send(null);
                    SRTlib.send('{"type":"FUNCTIONEND","function":"Upload._createClass.value._resumeUpload"},');

        }
      }, {
        key: "_startUpload",
        value: function _startUpload() {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"Upload._createClass.value._startUpload","fileName":"${__filename}","paramsNumber":0},`);

          var _this6 = this;
          if (this._aborted) {
                        SRTlib.send('{"type":"FUNCTIONEND","function":"Upload._createClass.value._startUpload"},');
        ...
        value: function _addChunkToRequest(xhr) {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"Upload._createClass.value._addChunkToRequest","fileName":"${__filename}","paramsNumber":1},`);
          ...
          this._source.slice(start, end, function (err, value, complete) {
            ...
            if (value === null) {
              ...
              _this7._emitProgress(_this7._offset, _this7._size);
                    ...
                    SRTlib.send('{"type":"FUNCTIONEND","function":"Upload._createClass.value._addChunkToRequest"},');

        }
      }, {
        key: "_handleUploadResponse",
        value: function _handleUploadResponse(xhr) {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"Upload._createClass.value._handleUploadResponse","fileName":"${__filename}","paramsNumber":1},`);

          var _this8 = this;
          var offset = parseInt(xhr.getResponseHeader("Upload-Offset"), 10);
          if (isNaN(offset)) {
            this._emitXhrError(xhr, new Error("tus: invalid or missing offset value"));
                        SRTlib.send('{"type":"FUNCTIONEND","function":"Upload._createClass.value._handleUploadResponse"},');
        ...
        value: function terminate(url, options, cb) {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"Upload._createClass.value.terminate","fileName":"${__filename}","paramsNumber":3},`);

          if (typeof options !== "function" && typeof cb !== "function") {
                        SRTlib.send('{"type":"FUNCTIONEND","function":"Upload._createClass.value.terminate"},');
  ...
  27: [function (require, module, exports) {
    ...
    (function (global) {
      ...
      var rules = [['#', 'hash'], ['?', 'query'], function sanitize(address) {
                SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"call.rules.sanitize","fileName":"${__filename}","paramsNumber":1},`);

                SRTlib.send('{"type":"FUNCTIONEND","function":"call.rules.sanitize"},');
      ...
      function Headers(headers) {
        ...
        if (headers instanceof Headers) {
          headers.forEach(function (value, name) {
                        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"emptyKey33","fileName":"${__filename}","paramsNumber":2},`);
          ...
          headers.forEach(function (header) {
                        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"emptyKey34","fileName":"${__filename}","paramsNumber":1},`);
  ...
  51: [function (require, module, exports) {
    ...
    module.exports = (_temp = _class = (function (_Plugin) {
      ...
      _proto.handleResetProgress = function handleResetProgress() {
                SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports._temp._class._proto.handleResetProgress.handleResetProgress","fileName":"${__filename}","paramsNumber":0},`);
        ...
        this.uppy.setState({
          files: files
                ...
                SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports._temp._class._proto.handleResetProgress.handleResetProgress"},');
      ...
      _proto.upload = function upload(file, current, total) {
        ...
        return new Promise(function (resolve, reject) {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports._temp._class._proto.upload.upload.ReturnStatement.catch7","fileName":"${__filename}","paramsNumber":2},`);
          ...
          _this2.onPause(file.id, function (isPaused) {
                        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports._temp._class._proto.upload.upload.ReturnStatement.catch3","fileName":"${__filename}","paramsNumber":1},`);
            ...
            if (isPaused) {
              ...
              queuedRequest = _this2.requests.run(function () {
                                SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports._temp._class._proto.upload.upload.ReturnStatement.catch.queuedRequest._this2.requests.run2","fileName":"${__filename}","paramsNumber":0},`);

                upload.start();
                                SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports._temp._class._proto.upload.upload.ReturnStatement.catch.queuedRequest._this2.requests.run2"},');

                return function () {
                                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports._temp._class._proto.upload.upload.ReturnStatement.catch.queuedRequest._this2.requests.run.ReturnStatement2","fileName":"${__filename}","paramsNumber":0},`);

                                    SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports._temp._class._proto.upload.upload.ReturnStatement.catch.queuedRequest._this2.requests.run.ReturnStatement2"},');
                        ...
                        SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports._temp._class._proto.upload.upload.ReturnStatement.catch3"},');

          });
          _this2.onPauseAll(file.id, function () {
                        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports._temp._class._proto.upload.upload.ReturnStatement.catch4","fileName":"${__filename}","paramsNumber":0},`);

            queuedRequest.abort();
            upload.abort();
                        SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports._temp._class._proto.upload.upload.ReturnStatement.catch4"},');

          });
          _this2.onCancelAll(file.id, function () {
                        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports._temp._class._proto.upload.upload.ReturnStatement.catch5","fileName":"${__filename}","paramsNumber":0},`);
            ...
            resolve("upload " + file.id + " was canceled");
                        SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports._temp._class._proto.upload.upload.ReturnStatement.catch5"},');

          });
          _this2.onResumeAll(file.id, function () {
                        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports._temp._class._proto.upload.upload.ReturnStatement.catch6","fileName":"${__filename}","paramsNumber":0},`);
            ...
            queuedRequest = _this2.requests.run(function () {
                            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports._temp._class._proto.upload.upload.ReturnStatement.catch.queuedRequest._this2.requests.run3","fileName":"${__filename}","paramsNumber":0},`);

              upload.start();
                            SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports._temp._class._proto.upload.upload.ReturnStatement.catch.queuedRequest._this2.requests.run3"},');

              return function () {
                                SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports._temp._class._proto.upload.upload.ReturnStatement.catch.queuedRequest._this2.requests.run.ReturnStatement3","fileName":"${__filename}","paramsNumber":0},`);

                                SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports._temp._class._proto.upload.upload.ReturnStatement.catch.queuedRequest._this2.requests.run.ReturnStatement3"},');

              };
                            SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports._temp._class._proto.upload.upload.ReturnStatement.catch.queuedRequest._this2.requests.run3"},');

            });
                        SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports._temp._class._proto.upload.upload.ReturnStatement.catch6"},');

          });
                    SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports._temp._class._proto.upload.upload.ReturnStatement.catch7"},');

        }).catch(function (err) {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports._temp._class._proto.upload.upload.ReturnStatement.catch8","fileName":"${__filename}","paramsNumber":1},`);

          _this2.uppy.emit('upload-error', file, err);
                    SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports._temp._class._proto.upload.upload.ReturnStatement.catch8"},');
      ...
      _proto.connectToServerSocket = function connectToServerSocket(file) {
        ...
        return new Promise(function (resolve, reject) {
          ...
          _this4.onFileRemove(file.id, function () {
                        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports._temp._class._proto.connectToServerSocket.connectToServerSocket.ReturnStatement","fileName":"${__filename}","paramsNumber":0},`);
          ...
          var queuedRequest = _this4.requests.run(function () {
            ...
            return function () {
                            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports._temp._class._proto.connectToServerSocket.connectToServerSocket.ReturnStatement.queuedRequest._this4.requests.run.ReturnStatement3","fileName":"${__filename}","paramsNumber":0},`);

                            SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports._temp._class._proto.connectToServerSocket.connectToServerSocket.ReturnStatement.queuedRequest._this4.requests.run.ReturnStatement3"},');
      ...
      _proto.onReceiveUploadUrl = function onReceiveUploadUrl(file, uploadURL) {
                SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports._temp._class._proto.onReceiveUploadUrl.onReceiveUploadUrl","fileName":"${__filename}","paramsNumber":2},`);

        var currentFile = this.uppy.getFile(file.id);
        if (!currentFile) {
                    SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports._temp._class._proto.onReceiveUploadUrl.onReceiveUploadUrl"},');
      ...
      _proto.onPause = function onPause(fileID, cb) {
                SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports._temp._class._proto.onPause.onPause","fileName":"${__filename}","paramsNumber":2},`);
        ...
        this.uploaderEvents[fileID].on('upload-pause', function (targetFileID, isPaused) {
          ...
          if (fileID === targetFileID) {
            cb(isPaused);
                ...
                SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports._temp._class._proto.onPause.onPause"},');
      ...
      _proto.handleUpload = function handleUpload(fileIDs) {
        ...
        var filesToUpload = fileIDs.map(function (fileID) {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports._temp._class._proto.handleUpload.handleUpload.filesToUpload","fileName":"${__filename}","paramsNumber":1},`);

                    SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports._temp._class._proto.handleUpload.handleUpload.filesToUpload"},');
      ...
      function Translator(locales) {
        ...
        if (Array.isArray(locales)) {
          locales.forEach(function (locale) {
                        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"emptyKey63","fileName":"${__filename}","paramsNumber":1},`);
      ...
      _proto.interpolate = function interpolate(phrase, options) {
        ...
        function insertReplacement(source, rx, replacement) {
          ...
          source.forEach(function (chunk) {
                        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"emptyKey64","fileName":"${__filename}","paramsNumber":1},`);
  ...
  75: [function (require, module, exports) {
    ...
    var onUploadSuccess = function onUploadSuccess(elForUploadedFiles) {
            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"onUploadSuccess","fileName":"${__filename}","paramsNumber":1},`);

            SRTlib.send('{"type":"FUNCTIONEND","function":"onUploadSuccess"},');

      return function (file, response) {
                SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"onUploadSuccess.onUploadSuccess.ReturnStatement","fileName":"${__filename}","paramsNumber":2},`);
    ...
    uploadBtn.addEventListener('click', function () {
            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"emptyKey85","fileName":"${__filename}","paramsNumber":0},`);
