...
function FileIcon() {
  ...
  return <svg aria-hidden="true" focusable="false" class="uppy-c-icon" width={11} height={14.5} viewBox="0 0 44 58">
...
function FolderIcon() {
  ...
  return <svg aria-hidden="true" focusable="false" class="uppy-c-icon" style={{
    width: 16,
    marginRight: 3
