...
module.exports = class Filter extends Component {
  ...
  preventEnterPress(ev) {
    ...
    if (ev.keyCode === 13) {
      ...
      ev.preventDefault();
        ...
        SRTlib.send('{"type":"FUNCTIONEND","function":"preventEnterPress"},');
  ...
  render() {
    ...
    return <div class="uppy-ProviderBrowser-search">
      ...
      return this.props.filterQuery(e);
            SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports.ReturnStatement"},');
        ...
        {this.props.filterInput && <button class="uppy-u-reset uppy-ProviderBrowser-searchClose" type="button" aria-label={this.props.i18n('resetFilter')} title={this.props.i18n('resetFilter')} onclick={this.props.filterQuery}>
