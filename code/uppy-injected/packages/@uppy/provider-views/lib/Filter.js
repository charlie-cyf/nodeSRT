...
module.exports = (function (_Component) {
  ...
  _proto.preventEnterPress = function preventEnterPress(ev) {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports._proto.preventEnterPress.preventEnterPress","fileName":"${__filename}","paramsNumber":1},`);

    if (ev.keyCode === 13) {
      ev.stopPropagation();
      ev.preventDefault();
    }
        SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports._proto.preventEnterPress.preventEnterPress"},');
  ...
  _proto.render = function render() {
    ...
    return h("div", {
      ...
      oninput: function oninput(e) {
                SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports._proto.render.render.ReturnStatement.h.h.oninput.oninput","fileName":"${__filename}","paramsNumber":1},`);

                SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports._proto.render.render.ReturnStatement.h.h.oninput.oninput"},');
