...
var getSharedProps = function getSharedProps(fileOrFolder, props) {
  ...
  return {
    ...
    getItemIcon: function getItemIcon() {
            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"getSharedProps.getSharedProps.ReturnStatement.getItemIcon.getItemIcon","fileName":"${__filename}","paramsNumber":0},`);

            SRTlib.send('{"type":"FUNCTIONEND","function":"getSharedProps.getSharedProps.ReturnStatement.getItemIcon.getItemIcon"},');
    ...
    toggleCheckbox: function toggleCheckbox(e) {
            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"getSharedProps.getSharedProps.ReturnStatement.toggleCheckbox.toggleCheckbox","fileName":"${__filename}","paramsNumber":1},`);

            SRTlib.send('{"type":"FUNCTIONEND","function":"getSharedProps.getSharedProps.ReturnStatement.toggleCheckbox.toggleCheckbox"},');
  ...
  return h("div", {
    ...
    return Item(_extends({}, getSharedProps(folder, props), {
      ...
      handleFolderClick: function handleFolderClick() {
                SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.ReturnStatement.h.h.props.folders.map.ReturnStatement.Item._extends.handleFolderClick.handleFolderClick","fileName":"${__filename}","paramsNumber":0},`);

                SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports.ReturnStatement.h.h.props.folders.map.ReturnStatement.Item._extends.handleFolderClick.handleFolderClick"},');
