...
var DashboardModal = (function (_React$Component) {
  ...
  function DashboardModal() {
        ...
        SRTlib.send('], "end": "DashboardModal"},');
  ...
  _proto.componentDidMount = function componentDidMount() {
    ...
    this.installPlugin();
        SRTlib.send('], "end": "DashboardModal._proto.componentDidMount.componentDidMount"},');
  ...
  _proto.componentDidUpdate = function componentDidUpdate(prevProps) {
    ...
    if (prevProps.open && !this.props.open) {
      ...
      this.plugin.openModal();
        ...
        SRTlib.send('], "end": "DashboardModal._proto.componentDidUpdate.componentDidUpdate"},');
  ...
  _proto.componentWillUnmount = function componentWillUnmount() {
    ...
    this.uninstallPlugin();
        SRTlib.send('], "end": "DashboardModal._proto.componentWillUnmount.componentWillUnmount"},');
  ...
  _proto.installPlugin = function installPlugin() {
    ...
    if (this.props.open) {
      this.plugin.openModal();
        ...
        SRTlib.send('], "end": "DashboardModal._proto.installPlugin.installPlugin"},');
  ...
  _proto.uninstallPlugin = function uninstallPlugin(props) {
    ...
    uppy.removePlugin(this.plugin);
        SRTlib.send('], "end": "DashboardModal._proto.uninstallPlugin.uninstallPlugin"},');
  ...
  _proto.render = function render() {
    ...
    var _this = this;
        SRTlib.send('], "end": "DashboardModal._proto.render.render"},');
    ...
    return h('div', {
      ref: function ref(container) {
        ...
        _this.container = container;
                SRTlib.send('], "end": "DashboardModal._proto.render.render.ReturnStatement.h.ref.ref"},');
