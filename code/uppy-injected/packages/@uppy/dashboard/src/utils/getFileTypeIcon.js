...
function iconImage() {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"iconImage","fileName":"/packages/@uppy/dashboard/src/utils/getFileTypeIcon.js","paramsNumber":0},`);

    SRTlib.send('{"type":"FUNCTIONEND","function":"iconImage"},');

  return <svg aria-hidden="true" focusable="false" width="25" height="25" viewBox="0 0 25 25">
...
function iconAudio() {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"iconAudio","fileName":"/packages/@uppy/dashboard/src/utils/getFileTypeIcon.js","paramsNumber":0},`);

    SRTlib.send('{"type":"FUNCTIONEND","function":"iconAudio"},');

  return <svg aria-hidden="true" focusable="false" class="uppy-c-icon" width="25" height="25" viewBox="0 0 25 25">
...
function iconVideo() {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"iconVideo","fileName":"/packages/@uppy/dashboard/src/utils/getFileTypeIcon.js","paramsNumber":0},`);
...
function iconPDF() {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"iconPDF","fileName":"/packages/@uppy/dashboard/src/utils/getFileTypeIcon.js","paramsNumber":0},`);
...
function iconArchive() {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"iconArchive","fileName":"/packages/@uppy/dashboard/src/utils/getFileTypeIcon.js","paramsNumber":0},`);
...
function iconFile() {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"iconFile","fileName":"/packages/@uppy/dashboard/src/utils/getFileTypeIcon.js","paramsNumber":0},`);
...
function iconText() {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"iconText","fileName":"/packages/@uppy/dashboard/src/utils/getFileTypeIcon.js","paramsNumber":0},`);
