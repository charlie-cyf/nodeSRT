...
function selectDocumentWithExpo(options) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"selectDocumentWithExpo","fileName":"/packages/@uppy/react-native/file-picker/selectDocument.js","paramsNumber":1},`);
  ...
  return Expo.DocumentPicker.getDocumentAsync({
    copyToCacheDirectory: false
        ...
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"ReturnStatement.Expo.DocumentPicker.getDocumentAsync.then","fileName":"/packages/@uppy/react-native/file-picker/selectDocument.js","paramsNumber":1},`);
