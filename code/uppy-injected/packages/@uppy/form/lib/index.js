...
module.exports = (_temp = _class = (function (_Plugin) {
  ...
  _proto.handleUploadStart = function handleUploadStart() {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports._temp._class._proto.handleUploadStart.handleUploadStart","fileName":"${__filename}","paramsNumber":0},`);

    if (this.opts.getMetaFromForm) {
      this.getMetaFromForm();
    }
        SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports._temp._class._proto.handleUploadStart.handleUploadStart"},');

  };
  _proto.handleSuccess = function handleSuccess(result) {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports._temp._class._proto.handleSuccess.handleSuccess","fileName":"${__filename}","paramsNumber":1},`);
    ...
    if (this.opts.submitOnSuccess) {
      this.form.submit();
        ...
        SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports._temp._class._proto.handleSuccess.handleSuccess"},');

  };
  _proto.handleFormSubmit = function handleFormSubmit(ev) {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports._temp._class._proto.handleFormSubmit.handleFormSubmit2","fileName":"${__filename}","paramsNumber":1},`);
    ...
    if (this.opts.triggerUploadOnSubmit) {
      ...
      elements.forEach(function (el) {
                SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports._temp._class._proto.handleFormSubmit.handleFormSubmit","fileName":"${__filename}","paramsNumber":1},`);
        ...
        if (isButton && !el.disabled) {
          ...
          disabledByUppy.push(el);
                ...
                SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports._temp._class._proto.handleFormSubmit.handleFormSubmit"},');

      });
      this.uppy.upload().then(function () {
                SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports._temp._class._proto.handleFormSubmit.handleFormSubmit.uppy.upload.then.catch.uppy.upload.then2","fileName":"${__filename}","paramsNumber":0},`);

        disabledByUppy.forEach(function (button) {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports._temp._class._proto.handleFormSubmit.handleFormSubmit.uppy.upload.then.catch.uppy.upload.then","fileName":"${__filename}","paramsNumber":1},`);
          ...
          button.disabled = false;
                ...
                SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports._temp._class._proto.handleFormSubmit.handleFormSubmit.uppy.upload.then.catch.uppy.upload.then4","fileName":"${__filename}","paramsNumber":1},`);

        disabledByUppy.forEach(function (button) {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports._temp._class._proto.handleFormSubmit.handleFormSubmit.uppy.upload.then.catch.uppy.upload.then3","fileName":"${__filename}","paramsNumber":1},`);

          button.disabled = false;
                    SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports._temp._class._proto.handleFormSubmit.handleFormSubmit.uppy.upload.then.catch.uppy.upload.then3"},');

        });
                SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports._temp._class._proto.handleFormSubmit.handleFormSubmit.uppy.upload.then.catch.uppy.upload.then4"},');
        ...
        SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports._temp._class._proto.handleFormSubmit.handleFormSubmit2"},');

  };
  _proto.addResultToForm = function addResultToForm(result) {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports._temp._class._proto.addResultToForm.addResultToForm","fileName":"${__filename}","paramsNumber":1},`);
    ...
    if (resultInput) {
      if (this.opts.multipleResults) {
        ...
        resultInput.value = JSON.stringify(result);
            ...
            SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports._temp._class._proto.addResultToForm.addResultToForm"},');
  ...
  _proto.getMetaFromForm = function getMetaFromForm() {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports._temp._class._proto.getMetaFromForm.getMetaFromForm","fileName":"${__filename}","paramsNumber":0},`);
    ...
    this.uppy.setMeta(formMeta);
        SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports._temp._class._proto.getMetaFromForm.getMetaFromForm"},');
