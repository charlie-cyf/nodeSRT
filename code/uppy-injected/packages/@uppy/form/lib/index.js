...
module.exports = (_temp = _class = (function (_Plugin) {
  ...
  _proto.handleUploadStart = function handleUploadStart() {
        SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.handleUploadStart.handleUploadStart", "fileName": "${__filename}", "paramsNumber": 0, "calls" : [`);
  ...
  _proto.handleSuccess = function handleSuccess(result) {
        SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.handleSuccess.handleSuccess", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
  ...
  _proto.handleFormSubmit = function handleFormSubmit(ev) {
        SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.handleFormSubmit.handleFormSubmit2", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
    ...
    if (this.opts.triggerUploadOnSubmit) {
      ...
      elements.forEach(function (el) {
                SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.handleFormSubmit.handleFormSubmit", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
      ...
      this.uppy.upload().then(function () {
                SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.handleFormSubmit.handleFormSubmit.uppy.upload.then.catch.uppy.upload.then2", "fileName": "${__filename}", "paramsNumber": 0, "calls" : [`);

        disabledByUppy.forEach(function (button) {
                    SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.handleFormSubmit.handleFormSubmit.uppy.upload.then.catch.uppy.upload.then", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
          ...
          button.disabled = false;
                ...
                SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.handleFormSubmit.handleFormSubmit.uppy.upload.then.catch.uppy.upload.then4", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);

        disabledByUppy.forEach(function (button) {
                    SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.handleFormSubmit.handleFormSubmit.uppy.upload.then.catch.uppy.upload.then3", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
        ...
        return Promise.reject(err);
                ...
                SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.handleFormSubmit.handleFormSubmit.uppy.upload.then.catch", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
  ...
  _proto.addResultToForm = function addResultToForm(result) {
        SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.addResultToForm.addResultToForm", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
  ...
  _proto.getMetaFromForm = function getMetaFromForm() {
        SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.getMetaFromForm.getMetaFromForm", "fileName": "${__filename}", "paramsNumber": 0, "calls" : [`);
