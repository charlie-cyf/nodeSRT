...
describe('dataURItoBlob', () => {
    ...
    SRTlib.send(`{ "testSuiteName": "dataURItoBlob", "fileName": "/packages/@uppy/utils/src/dataURItoBlob.test.js", "calls" : [`);
  });

    beforeEach(() => {
    SRTlib.send(`{ "testName": "${escape(jasmine["currentTest"].description)}", "fileName": "/packages/@uppy/utils/src/dataURItoBlob.test.js", "calls" : [`);
  });
