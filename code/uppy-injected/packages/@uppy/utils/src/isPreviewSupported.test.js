...
describe('isPreviewSupported', () => {
    ...
    SRTlib.send(`{ "testSuite": "isPreviewSupported", "fileName": "${__filename}", "calls" : [`);
  ...
  it('should return true for any filetypes that browsers can preview', () => {
    ...
    expect(isPreviewSupported('foo')).toEqual(false);
        SRTlib.send('], "end": "test-should%20return%20true%20for%20any%20filetypes%20that%20browsers%20can%20preview"},');
    SRTlib.endLogger();
