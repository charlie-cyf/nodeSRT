...
var ReduxStore = (function () {
  ...
  _proto.setState = function setState(patch) {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"ReduxStore._proto.setState.setState","fileName":"${__filename}","paramsNumber":1},`);
    ...
    this._store.dispatch({
      ...
      payload: patch
        ...
        SRTlib.send('{"type":"FUNCTIONEND","function":"ReduxStore._proto.setState.setState"},');

  };
  _proto.getState = function getState() {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"ReduxStore._proto.getState.getState","fileName":"${__filename}","paramsNumber":0},`);

        SRTlib.send('{"type":"FUNCTIONEND","function":"ReduxStore._proto.getState.getState"},');
  ...
  _proto.subscribe = function subscribe(cb) {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"ReduxStore._proto.subscribe.subscribe","fileName":"${__filename}","paramsNumber":1},`);

    var _this = this;
    var prevState = this.getState();
        SRTlib.send('{"type":"FUNCTIONEND","function":"ReduxStore._proto.subscribe.subscribe"},');
...
module.exports = function createReduxStore(opts) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.createReduxStore","fileName":"${__filename}","paramsNumber":1},`);

    SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports.createReduxStore"},');
