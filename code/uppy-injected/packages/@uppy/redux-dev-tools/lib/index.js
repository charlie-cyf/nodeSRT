...
module.exports = (_temp = _class = (function (_Plugin) {
  ...
  _proto.handleStateChange = function handleStateChange(prevState, nextState, patch) {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports._temp._class._proto.handleStateChange.handleStateChange","fileName":"${__filename}","paramsNumber":3},`);

    this.devTools.send('UPPY_STATE_UPDATE', nextState);
        SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports._temp._class._proto.handleStateChange.handleStateChange"},');

  };
  _proto.initDevTools = function initDevTools() {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports._temp._class._proto.initDevTools.initDevTools","fileName":"${__filename}","paramsNumber":0},`);
      ...
      if (message.type === 'DISPATCH') {
        ...
        switch (message.payload.type) {
          case 'RESET':
                        ...
                        SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports._temp._class._proto.initDevTools.initDevTools"},');
