...
module.exports = (_temp = _class = (function (_Plugin) {
  ...
  _proto.handleStateChange = function handleStateChange(prevState, nextState, patch) {
        SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.handleStateChange.handleStateChange", "fileName": "${__filename}", "paramsNumber": 3, "calls" : [`);
  ...
  _proto.initDevTools = function initDevTools() {
        SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.initDevTools.initDevTools", "fileName": "${__filename}", "paramsNumber": 0, "calls" : [`);

    var _this2 = this;
    this.devTools = window.devToolsExtension.connect();
    this.devToolsUnsubscribe = this.devTools.subscribe(function (message) {
            SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.initDevTools.initDevTools.devToolsUnsubscribe.devTools.subscribe", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
