...
function isIPAddress(address) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"isIPAddress","fileName":"/packages/@uppy/companion/lib/server/helpers/request.js","paramsNumber":1},`);
...
function isPrivateIP(ipAddress) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"isPrivateIP","fileName":"/packages/@uppy/companion/lib/server/helpers/request.js","paramsNumber":1},`);
...
module.exports.getProtectedHttpAgent = (protocol, blockPrivateIPs) => {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.getProtectedHttpAgent","fileName":"/packages/@uppy/companion/lib/server/helpers/request.js","paramsNumber":2},`);
...
function dnsLookup(hostname, options, callback) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"dnsLookup","fileName":"/packages/@uppy/companion/lib/server/helpers/request.js","paramsNumber":3},`);

  dns.lookup(hostname, options, (err, addresses, maybeFamily) => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"dns.lookup","fileName":"/packages/@uppy/companion/lib/server/helpers/request.js","paramsNumber":3},`);
...
class HttpAgent extends http.Agent {
  createConnection(options, callback) {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"createConnection","fileName":"/packages/@uppy/companion/lib/server/helpers/request.js","paramsNumber":2,"classInfo":{"className":"HttpAgent"}},`);
...
class HttpsAgent extends https.Agent {
  createConnection(options, callback) {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"createConnection","fileName":"/packages/@uppy/companion/lib/server/helpers/request.js","paramsNumber":2,"classInfo":{"className":"HttpsAgent"}},`);
