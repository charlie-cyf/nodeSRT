...
exports.hasSessionAndProvider = (req, res, next) => {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"exports.hasSessionAndProvider","fileName":"/packages/@uppy/companion/lib/server/middlewares.js","paramsNumber":3},`);
...
exports.verifyToken = (req, res, next) => {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"exports.verifyToken","fileName":"/packages/@uppy/companion/lib/server/middlewares.js","paramsNumber":3},`);
...
exports.gentleVerifyToken = (req, res, next) => {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"exports.gentleVerifyToken","fileName":"/packages/@uppy/companion/lib/server/middlewares.js","paramsNumber":3},`);
...
exports.cookieAuthToken = (req, res, next) => {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"exports.cookieAuthToken","fileName":"/packages/@uppy/companion/lib/server/middlewares.js","paramsNumber":3},`);
