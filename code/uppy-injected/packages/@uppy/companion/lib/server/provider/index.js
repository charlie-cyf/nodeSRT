...
module.exports.getProviderMiddleware = providers => {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.getProviderMiddleware","fileName":"/packages/@uppy/companion/lib/server/provider/index.js","paramsNumber":1},`);

  const middleware = (req, res, next, providerName) => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"middleware","fileName":"/packages/@uppy/companion/lib/server/provider/index.js","paramsNumber":4},`);
...
module.exports.getDefaultProviders = companionOptions => {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.getDefaultProviders","fileName":"/packages/@uppy/companion/lib/server/provider/index.js","paramsNumber":1},`);
  ...
  const usesGraphAPI = () => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"usesGraphAPI","fileName":"/packages/@uppy/companion/lib/server/provider/index.js","paramsNumber":0},`);
...
module.exports.addCustomProviders = (customProviders, providers, grantConfig) => {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.addCustomProviders","fileName":"/packages/@uppy/companion/lib/server/provider/index.js","paramsNumber":3},`);

  Object.keys(customProviders).forEach(providerName => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"Object.keys.forEach","fileName":"/packages/@uppy/companion/lib/server/provider/index.js","paramsNumber":1},`);
...
module.exports.addProviderOptions = (companionOptions, grantConfig) => {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.addProviderOptions","fileName":"/packages/@uppy/companion/lib/server/provider/index.js","paramsNumber":2},`);
  ...
  const keys = Object.keys(providerOptions).filter(key => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"keys.Object.keys.filter","fileName":"/packages/@uppy/companion/lib/server/provider/index.js","paramsNumber":1},`);
  ...
  keys.forEach(authProvider => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"keys.forEach","fileName":"/packages/@uppy/companion/lib/server/provider/index.js","paramsNumber":1},`);
...
const authNameToProvider = (authProvider, options) => {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"authNameToProvider","fileName":"/packages/@uppy/companion/lib/server/provider/index.js","paramsNumber":2},`);
...
const validOptions = options => {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"validOptions","fileName":"/packages/@uppy/companion/lib/server/provider/index.js","paramsNumber":1},`);
