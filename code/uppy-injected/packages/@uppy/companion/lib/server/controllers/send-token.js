...
module.exports = function sendToken(req, res, next) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports","fileName":"/packages/@uppy/companion/lib/server/controllers/send-token.js","paramsNumber":3},`);
...
const htmlContent = (token, origin) => {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"htmlContent","fileName":"/packages/@uppy/companion/lib/server/controllers/send-token.js","paramsNumber":2},`);
...
const oldHtmlContent = (token, origin) => {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"oldHtmlContent","fileName":"/packages/@uppy/companion/lib/server/controllers/send-token.js","paramsNumber":2},`);
