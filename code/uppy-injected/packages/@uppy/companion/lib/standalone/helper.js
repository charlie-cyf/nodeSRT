...
exports.getCompanionOptions = () => {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"exports.getCompanionOptions","fileName":"/packages/@uppy/companion/lib/standalone/helper.js","paramsNumber":0},`);
...
const getConfigFromEnv = () => {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"getConfigFromEnv","fileName":"/packages/@uppy/companion/lib/standalone/helper.js","paramsNumber":0},`);
...
const getSecret = baseEnvVar => {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"getSecret","fileName":"/packages/@uppy/companion/lib/standalone/helper.js","paramsNumber":1},`);
...
const generateSecret = () => {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"generateSecret","fileName":"/packages/@uppy/companion/lib/standalone/helper.js","paramsNumber":0},`);
...
const getConfigFromFile = () => {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"getConfigFromFile","fileName":"/packages/@uppy/companion/lib/standalone/helper.js","paramsNumber":0},`);
...
const getConfigPath = () => {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"getConfigPath","fileName":"/packages/@uppy/companion/lib/standalone/helper.js","paramsNumber":0},`);
...
exports.hasProtocol = url => {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"exports.hasProtocol","fileName":"/packages/@uppy/companion/lib/standalone/helper.js","paramsNumber":1},`);
...
exports.buildHelpfulStartupMessage = companionOptions => {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"exports.buildHelpfulStartupMessage","fileName":"/packages/@uppy/companion/lib/standalone/helper.js","paramsNumber":1},`);

  const buildURL = utils.getURLBuilder(companionOptions);
  const callbackURLs = [];
  Object.keys(companionOptions.providerOptions).forEach(providerName => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"Object.keys.forEach","fileName":"/packages/@uppy/companion/lib/standalone/helper.js","paramsNumber":1},`);
