...
exports.setMaskables = maskables => {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"exports.setMaskables","fileName":"/packages/@uppy/companion/src/server/logger.js","paramsNumber":1},`);

  maskables.forEach(i => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"maskables.forEach","fileName":"/packages/@uppy/companion/src/server/logger.js","paramsNumber":1},`);
...
exports.info = (msg, tag, traceId) => {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"exports.info","fileName":"/packages/@uppy/companion/src/server/logger.js","paramsNumber":3},`);
...
exports.warn = (msg, tag, traceId) => {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"exports.warn","fileName":"/packages/@uppy/companion/src/server/logger.js","paramsNumber":3},`);
...
exports.error = (msg, tag, traceId, shouldLogStackTrace) => {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"exports.error","fileName":"/packages/@uppy/companion/src/server/logger.js","paramsNumber":4},`);
...
exports.debug = (msg, tag, traceId) => {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"exports.debug","fileName":"/packages/@uppy/companion/src/server/logger.js","paramsNumber":3},`);
...
const log = (msg, tag, level, id, color, shouldLogStackTrace) => {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"log","fileName":"/packages/@uppy/companion/src/server/logger.js","paramsNumber":6},`);
  ...
  color = color || (message => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"color","fileName":"/packages/@uppy/companion/src/server/logger.js","paramsNumber":1},`);
...
const maskMessage = msg => {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"maskMessage","fileName":"/packages/@uppy/companion/src/server/logger.js","paramsNumber":1},`);
