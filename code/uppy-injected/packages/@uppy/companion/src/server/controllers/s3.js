...
module.exports = function s3(config) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports","fileName":"/packages/@uppy/companion/src/server/controllers/s3.js","paramsNumber":1},`);
  ...
  function getUploadParameters(req, res, next) {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"getUploadParameters","fileName":"/packages/@uppy/companion/src/server/controllers/s3.js","paramsNumber":3},`);
    ...
    Object.keys(metadata).forEach(key => {
            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"Object.keys.forEach","fileName":"/packages/@uppy/companion/src/server/controllers/s3.js","paramsNumber":1},`);
    ...
    client.createPresignedPost({
      ...
      Conditions: config.conditions
            ...
            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"client.createPresignedPost","fileName":"/packages/@uppy/companion/src/server/controllers/s3.js","paramsNumber":2},`);
  ...
  function createMultipartUpload(req, res, next) {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"createMultipartUpload","fileName":"/packages/@uppy/companion/src/server/controllers/s3.js","paramsNumber":3},`);
    ...
    client.createMultipartUpload({
      ...
      Expires: config.expires
            ...
            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"client.createMultipartUpload","fileName":"/packages/@uppy/companion/src/server/controllers/s3.js","paramsNumber":2},`);
  ...
  function getUploadedParts(req, res, next) {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"getUploadedParts","fileName":"/packages/@uppy/companion/src/server/controllers/s3.js","paramsNumber":3},`);
    ...
    function listPartsPage(startAt) {
            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"listPartsPage","fileName":"/packages/@uppy/companion/src/server/controllers/s3.js","paramsNumber":1},`);
      ...
      client.listParts({
        ...
        PartNumberMarker: startAt
                ...
                SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"client.listParts","fileName":"/packages/@uppy/companion/src/server/controllers/s3.js","paramsNumber":2},`);
    ...
    function done() {
            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"done","fileName":"/packages/@uppy/companion/src/server/controllers/s3.js","paramsNumber":0},`);
  ...
  function signPartUpload(req, res, next) {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"signPartUpload","fileName":"/packages/@uppy/companion/src/server/controllers/s3.js","paramsNumber":3},`);
    ...
    client.getSignedUrl('uploadPart', {
      ...
      Expires: config.expires
            ...
            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"client.getSignedUrl","fileName":"/packages/@uppy/companion/src/server/controllers/s3.js","paramsNumber":2},`);
  ...
  function abortMultipartUpload(req, res, next) {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"abortMultipartUpload","fileName":"/packages/@uppy/companion/src/server/controllers/s3.js","paramsNumber":3},`);
    ...
    client.abortMultipartUpload({
      ...
      UploadId: uploadId
            ...
            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"client.abortMultipartUpload","fileName":"/packages/@uppy/companion/src/server/controllers/s3.js","paramsNumber":2},`);
  ...
  function completeMultipartUpload(req, res, next) {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"completeMultipartUpload","fileName":"/packages/@uppy/companion/src/server/controllers/s3.js","paramsNumber":3},`);
    ...
    client.completeMultipartUpload({
      ...
      MultipartUpload: {
        Parts: parts
            ...
            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"client.completeMultipartUpload","fileName":"/packages/@uppy/companion/src/server/controllers/s3.js","paramsNumber":2},`);
...
function isValidPart(part) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"isValidPart","fileName":"/packages/@uppy/companion/src/server/controllers/s3.js","paramsNumber":1},`);
