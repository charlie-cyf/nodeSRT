...
function get(req, res, next) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"get","fileName":"/packages/@uppy/companion/src/server/controllers/get.js","paramsNumber":3},`);
  ...
  provider.size({
    ...
    query: req.query
        ...
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"provider.size","fileName":"/packages/@uppy/companion/src/server/controllers/get.js","paramsNumber":2},`);
    ...
    uploader.onSocketReady(() => {
            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"uploader.onSocketReady","fileName":"/packages/@uppy/companion/src/server/controllers/get.js","paramsNumber":0},`);
