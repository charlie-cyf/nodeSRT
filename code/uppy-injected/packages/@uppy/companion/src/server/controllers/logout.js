...
function logout(req, res, next) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"logout","fileName":"/packages/@uppy/companion/src/server/controllers/logout.js","paramsNumber":3},`);

  const cleanSession = () => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"cleanSession","fileName":"/packages/@uppy/companion/src/server/controllers/logout.js","paramsNumber":0},`);
  ...
  if (token) {
    req.companion.provider.logout({
      token
            ...
            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"req.companion.provider.logout","fileName":"/packages/@uppy/companion/src/server/controllers/logout.js","paramsNumber":2},`);
