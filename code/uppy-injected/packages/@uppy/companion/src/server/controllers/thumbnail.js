...
function thumbnail(req, res, next) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"thumbnail","fileName":"/packages/@uppy/companion/src/server/controllers/thumbnail.js","paramsNumber":3},`);
  ...
  provider.thumbnail({
    ...
    token
        ...
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"provider.thumbnail","fileName":"/packages/@uppy/companion/src/server/controllers/thumbnail.js","paramsNumber":2},`);
