...
exports.startCleanUpJob = dirPath => {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"exports.startCleanUpJob","fileName":"/packages/@uppy/companion/src/server/jobs.js","paramsNumber":1},`);

  logger.info('starting clean up job', 'jobs.cleanup.start');
  schedule.scheduleJob('0 23 * * *', () => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"schedule.scheduleJob","fileName":"/packages/@uppy/companion/src/server/jobs.js","paramsNumber":0},`);
...
const cleanUpFinishedUploads = dirPath => {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"cleanUpFinishedUploads","fileName":"/packages/@uppy/companion/src/server/jobs.js","paramsNumber":1},`);

  logger.info(`running clean up job for path: ${dirPath}`, 'jobs.cleanup.progress.read');
  fs.readdir(dirPath, (err, files) => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"fs.readdir","fileName":"/packages/@uppy/companion/src/server/jobs.js","paramsNumber":2},`);
    ...
    files.forEach((file, fileIndex) => {
            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"files.forEach","fileName":"/packages/@uppy/companion/src/server/jobs.js","paramsNumber":2},`);
      ...
      fs.stat(fullPath, (err, stats) => {
                SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"fs.stat","fileName":"/packages/@uppy/companion/src/server/jobs.js","paramsNumber":2},`);
        ...
        fs.unlink(fullPath, err => {
                    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"fs.unlink","fileName":"/packages/@uppy/companion/src/server/jobs.js","paramsNumber":1},`);
