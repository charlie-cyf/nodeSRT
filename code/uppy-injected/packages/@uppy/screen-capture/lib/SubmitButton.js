...
module.exports = function SubmitButton(_ref) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.SubmitButton","fileName":"${__filename}","paramsNumber":1},`);

  var recording = _ref.recording, recordedVideo = _ref.recordedVideo, onSubmit = _ref.onSubmit, i18n = _ref.i18n;
  if (recordedVideo && !recording) {
        SRTlib.send('{"type":"FUNCTIONEND","function":"module.exports.SubmitButton"},');
