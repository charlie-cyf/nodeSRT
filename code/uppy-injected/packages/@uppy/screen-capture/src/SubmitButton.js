...
module.exports = function SubmitButton({recording, recordedVideo, onSubmit, i18n}) {
  ...
  if (recordedVideo && !recording) {
    ...
    return <button class="uppy-u-reset uppy-c-btn uppy-ScreenCapture-button uppy-ScreenCapture-button--submit" type="button" title={i18n('submitRecordedFile')} aria-label={i18n('submitRecordedFile')} onclick={onSubmit} data-uppy-super-focusable>
