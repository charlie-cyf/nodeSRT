...
module.exports = (_temp = _class = (function (_Plugin) {
  ...
  _proto.getUploadParameters = function getUploadParameters(file) {
        SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.getUploadParameters.getUploadParameters", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
    ...
    this.opts.metaFields.forEach(function (key) {
            SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.getUploadParameters.getUploadParameters.opts.metaFields.forEach", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
  ...
  _proto.validateParameters = function validateParameters(file, params) {
        SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.validateParameters.validateParameters", "fileName": "${__filename}", "paramsNumber": 2, "calls" : [`);
  ...
  _proto.handleUpload = function handleUpload(fileIDs) {
        SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.handleUpload.handleUpload2", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
    ...
    var getUploadParameters = this.requests.wrapPromiseFunction(function (file) {
            SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.handleUpload.handleUpload.getUploadParameters.requests.wrapPromiseFunction", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
    ...
    return settle(fileIDs.map(function (id, index) {
            SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.handleUpload.handleUpload.ReturnStatement.then.settle", "fileName": "${__filename}", "paramsNumber": 2, "calls" : [`);

      paramsPromises[id] = getUploadParameters(_this2.uppy.getFile(id));
            SRTlib.send("]},");

      return paramsPromises[id].then(function (params) {
                SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.handleUpload.handleUpload.ReturnStatement.then.settle.ReturnStatement.paramsPromises.id.then.catch.paramsPromises.id.then", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
        ...
        return _this2._uploader.uploadFile(file.id, index, numberOfFiles);
                ...
                SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.handleUpload.handleUpload.ReturnStatement.then.settle.ReturnStatement.paramsPromises.id.then.catch", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
        ...
        _this2.uppy.emit('upload-error', file, error);
            ...
            SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.handleUpload.handleUpload.ReturnStatement.then", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
