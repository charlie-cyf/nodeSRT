...
module.exports = /*#__PURE__*/function () {
  ...
  _proto._uploadLocalFile = function _uploadLocalFile(file, current, total) {
    ...
    return new Promise(function (resolve, reject) {
      SRTlib.send("{\"type\":\"FUNCTIONSTART\",\"anonymous\":true,\"function\":\"emptyKey16\",\"fileName\":\"" + __filename + "\",\"paramsNumber\":2},"); // This is done in index.js in the S3 plugin.
  ...
  _proto._uploadRemoteFile = function _uploadRemoteFile(file, current, total) {
    ...
    return new Promise(function (resolve, reject) {
      SRTlib.send("{\"type\":\"FUNCTIONSTART\",\"anonymous\":true,\"function\":\"emptyKey29\",\"fileName\":\"" + __filename + "\",\"paramsNumber\":2},"); // This is done in index.js in the S3 plugin.
      // this.uppy.emit('upload-started', file)
