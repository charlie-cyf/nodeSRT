...
async function updateContributorsListInReadme() {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"updateContributorsListInReadme","fileName":"/bin/update-contributors.js","paramsNumber":0},`);
  ...
  if (stdout === '' || stdout === null) {
    console.log('Empty response from githubcontrib. GitHub’s rate limit?');
        SRTlib.send('{"type":"FUNCTIONEND","function":"updateContributorsListInReadme"},');
  ...
  fs.writeFileSync(README_FILE_NAME, readmeWithUpdatedContributors);
    SRTlib.send('{"type":"FUNCTIONEND","function":"updateContributorsListInReadme","paramsNumber":0},');
