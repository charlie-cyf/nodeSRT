...
describe('File upload with Instagram Provider', () => {
    ...
    SRTlib.send(`{ "testSuiteName": "File%20upload%20with%20Instagram%20Provider", "fileName": "/test/endtoend/providers/provider.instagram.test.js", "calls" : [`);
  });

  beforeEach(async () => {
        SRTlib.send(`{ "testName": "${this.test}", "fileName": "/test/endtoend/providers/provider.instagram.test.js", "calls" : [`);
