...
describe('File upload with Dropbox Provider', () => {
    ...
    SRTlib.send(`{ "testSuiteName": "File%20upload%20with%20Dropbox%20Provider", "fileName": "/test/endtoend/providers/provider.dropbox.test.js", "calls" : [`);
  });

  beforeEach(async () => {
        SRTlib.send(`{ "testName": "${this.test}", "fileName": "/test/endtoend/providers/provider.dropbox.test.js", "calls" : [`);
