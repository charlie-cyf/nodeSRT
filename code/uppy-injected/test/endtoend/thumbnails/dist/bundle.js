...
(function () {
  ...
  8: [function (require, module, exports) {
    ...
    (function (process, global) {
            SRTlib.send(`{ "anonymous": true, "function": "call5", "fileName": "${__filename}", "paramsNumber": 2, "calls" : [`);
  ...
  28: [function (require, module, exports) {
    ...
    function _extends() {
      ...
      _extends = Object.assign || (function (target) {
                SRTlib.send(`{ "anonymous": true, "function": "emptyKey40", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
    ...
    module.exports = (_temp = _class = (function (_Plugin) {
      ...
      function ThumbnailGenerator(uppy, opts) {
        ...
        _this.waitUntilAllProcessed = function (fileIDs) {
          ...
          var emitPreprocessCompleteForAll = function emitPreprocessCompleteForAll() {
                        SRTlib.send(`{ "anonymous": true, "function": "_this.waitUntilAllProcessed.emitPreprocessCompleteForAll.emitPreprocessCompleteForAll2", "fileName": "${__filename}", "paramsNumber": 0, "calls" : [`);
      ...
      _proto.createThumbnail = function createThumbnail(file, targetWidth, targetHeight) {
                SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.createThumbnail.createThumbnail", "fileName": "${__filename}", "paramsNumber": 3, "calls" : [`);

        var _this2 = this;
        var originalUrl = URL.createObjectURL(file.data);
        var onload = new Promise(function (resolve, reject) {
                    SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.createThumbnail.createThumbnail.onload3", "fileName": "${__filename}", "paramsNumber": 2, "calls" : [`);

          var image = new Image();
          image.src = originalUrl;
          image.addEventListener('load', function () {
                        SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.createThumbnail.createThumbnail.onload", "fileName": "${__filename}", "paramsNumber": 0, "calls" : [`);
          ...
          image.addEventListener('error', function (event) {
                        SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.createThumbnail.createThumbnail.onload2", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
        ...
        var orientationPromise = exifr.rotation(file.data).catch(function (_err) {
                    SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.createThumbnail.createThumbnail.orientationPromise.catch", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
        ...
        return Promise.all([onload, orientationPromise]).then(function (_ref) {
                    SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.createThumbnail.createThumbnail.ReturnStatement.then.then.then", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
          ...
          return _this2.canvasToBlob(resizedImage, 'image/jpeg', 80);
                    ...
                    SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.createThumbnail.createThumbnail.ReturnStatement.then.then", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
      ...
      _proto.getProportionalDimensions = function getProportionalDimensions(img, width, height, rotation) {
                SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.getProportionalDimensions.getProportionalDimensions", "fileName": "${__filename}", "paramsNumber": 4, "calls" : [`);
      ...
      _proto.protect = function protect(image) {
                SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.protect.protect", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
      ...
      _proto.resizeImage = function resizeImage(image, targetWidth, targetHeight) {
                SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.resizeImage.resizeImage", "fileName": "${__filename}", "paramsNumber": 3, "calls" : [`);
      ...
      _proto.rotateImage = function rotateImage(image, translate) {
                SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.rotateImage.rotateImage", "fileName": "${__filename}", "paramsNumber": 2, "calls" : [`);
      ...
      _proto.canvasToBlob = function canvasToBlob(canvas, type, quality) {
                SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.canvasToBlob.canvasToBlob", "fileName": "${__filename}", "paramsNumber": 3, "calls" : [`);
        ...
        if (canvas.toBlob) {
          ...
          return new Promise(function (resolve) {
                        SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.canvasToBlob.canvasToBlob.ReturnStatement.then", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);

            canvas.toBlob(resolve, type, quality);
                        SRTlib.send("]},");

          }).then(function (blob) {
                        SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.canvasToBlob.canvasToBlob.ReturnStatement.then2", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
        ...
        return Promise.resolve().then(function () {
                    SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.canvasToBlob.canvasToBlob.ReturnStatement.then.then.then", "fileName": "${__filename}", "paramsNumber": 0, "calls" : [`);
          ...
          return dataURItoBlob(canvas.toDataURL(type, quality), {});
                    ...
                    SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.canvasToBlob.canvasToBlob.ReturnStatement.then.then", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
      ...
      _proto.setPreviewURL = function setPreviewURL(fileID, preview) {
                SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.setPreviewURL.setPreviewURL", "fileName": "${__filename}", "paramsNumber": 2, "calls" : [`);
      ...
      _proto.addToQueue = function addToQueue(item) {
                SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.addToQueue.addToQueue", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
      ...
      _proto.processQueue = function processQueue() {
                SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.processQueue.processQueue", "fileName": "${__filename}", "paramsNumber": 0, "calls" : [`);
        ...
        if (this.queue.length > 0) {
          ...
          return this.requestThumbnail(current).catch(function (err) {
                        SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.processQueue.processQueue.ReturnStatement.requestThumbnail.catch.then.requestThumbnail.catch", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);

                        SRTlib.send("]},");

          }).then(function () {
                        SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.processQueue.processQueue.ReturnStatement.requestThumbnail.catch.then", "fileName": "${__filename}", "paramsNumber": 0, "calls" : [`);
      ...
      _proto.requestThumbnail = function requestThumbnail(file) {
                SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.requestThumbnail.requestThumbnail", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
        ...
        if (isPreviewSupported(file.type) && !file.isRemote) {
          ...
          return this.createThumbnail(file, this.opts.thumbnailWidth, this.opts.thumbnailHeight).then(function (preview) {
                        SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.requestThumbnail.requestThumbnail.ReturnStatement.createThumbnail.then.catch.createThumbnail.then", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
            ...
            _this4.uppy.emit('thumbnail:generated', _this4.uppy.getFile(file.id), preview);
                        ...
                        SRTlib.send(`{ "anonymous": true, "function": "module.exports._proto.requestThumbnail.requestThumbnail.ReturnStatement.createThumbnail.then.catch", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
  ...
  29: [function (require, module, exports) {
    ...
    (function (process, global, Buffer) {
            SRTlib.send(`{ "anonymous": true, "function": "call9", "fileName": "${__filename}", "paramsNumber": 3, "calls" : [`);
      ...
      !(function (e, t) {
        ...
        function f(e, t, n) {
          ...
          return (f = o() ? Reflect.construct : function (e, t, n) {
                        SRTlib.send(`{ "anonymous": true, "function": "ReturnStatement.apply", "fileName": "${__filename}", "paramsNumber": 3, "calls" : [`);
        ...
        function d(e, t, n) {
          ...
          return (d = "undefined" != typeof Reflect && Reflect.get ? Reflect.get : function (e, t, n) {
                        SRTlib.send(`{ "anonymous": true, "function": "ReturnStatement14", "fileName": "${__filename}", "paramsNumber": 3, "calls" : [`);
              ...
              n({
                ...
                arrayBuffer: function () {
                  ...
                  return Promise.resolve(i.response);
                    ...
                    SRTlib.send(`{ "anonymous": true, "function": "call.A", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
        ...
        var E = (function () {
          ...
          function e(n) {
            ...
            if ((t(this, e), "boolean" == typeof s && (this.le = s), Array.isArray(n) && (n = new Uint8Array(n)), 0 === n)) (this.byteOffset = 0, this.byteLength = 0); else if (n instanceof ArrayBuffer) {
              ...
              if ((void 0 === i && (i = n.byteLength - r), (r += n.byteOffset) + i > n.byteOffset + n.byteLength)) throw T("Creating view outside of available memory in ArrayBuffer");
              var u = new DataView(n.buffer, r, i);
              this._swapDataView(u);
            } else {
              if ("number" != typeof n) throw T("Invalid input argument for BufferView: " + n);
          ...
          return (r(e, null, [{
            ...
            value: function (t, n) {
              ...
              if ((t instanceof DataView || t instanceof e ? t = new Uint8Array(t.buffer, t.byteOffset, t.byteLength) : t instanceof ArrayBuffer && (t = new Uint8Array(t)), !(t instanceof Uint8Array))) throw T("BufferView.set(): Invalid data argument.");
              var i = this.toUint8();
                            SRTlib.send("]},");
        ...
        var te = O(), ne = O(), re = O(), ie = ["chunked", "firstChunkSize", "firstChunkSizeNode", "firstChunkSizeBrowser", "chunkSize", "chunkLimit"], se = ["jfif", "xmp", "icc", "iptc"], ae = ["tiff"].concat(se), ue = ["ifd0", "ifd1", "exif", "gps", "interop"], oe = [].concat(ae, ue), fe = ["makerNote", "userComment"], he = ["translateKeys", "translateValues", "reviveValues", "multiSegment"], ce = [].concat(he, ["sanitize", "mergeOutput"]), le = (function () {
          ...
          function n(e, r, s, u) {
            ...
            if ((t(this, n), i(c(o = l(this, a(n).call(this))), "enabled", !1), i(c(o), "skip", A()), i(c(o), "pick", A()), i(c(o), "deps", A()), i(c(o), "translateKeys", !1), i(c(o), "translateValues", !1), i(c(o), "reviveValues", !1), o.key = e, o.enabled = r, o.parse = o.enabled, o.applyInheritables(u), o.canBeFiltered = ue.includes(e), o.canBeFiltered && (o.dict = te.get(e)), void 0 !== s)) if (Array.isArray(s)) (o.parse = o.enabled = !0, o.canBeFiltered && s.length > 0 && o.translateTagSet(s, o.pick)); else if ("object" == typeof s) {
              ...
              if (!0 !== s && !1 !== s) throw T(("Invalid options argument: ").concat(s));
              o.parse = o.enabled = s;
            }
                        SRTlib.send("]},");
          ...
          function n(e) {
            ...
            if ((t(this, n), r = l(this, a(n).call(this)), !0 === e)) r.setupFromTrue(); else if (void 0 === e) r.setupFromUndefined(); else if (Array.isArray(e)) r.setupFromArray(e); else {
              if ("object" != typeof e) throw T(("Invalid options argument ").concat(e));
              r.setupFromObject(e);
            }
                        SRTlib.send("]},");
            ...
            value: function () {
              ...
              if (!this.fileParser) {
                ...
                if (18761 === t || 19789 === t) (this.file.isTiff = !0, e = N.get("tiff")); else if (65496 === t) (this.file.isJpeg = !0, e = N.get("jpeg")); else {
                  ...
                  })(this.file)) throw T("Unknown file format");
              ...
              try {
                ...
                return (e.setup(), Se(e.fileParser.parse(), function () {
                  ...
                  var t, n = {}, r = [], i = p(e.parsers).map((t = function (t) {
                                        SRTlib.send(`{ "anonymous": true, "function": "call.xe.ReturnStatement.r.value.ReturnStatement.Se.i.map", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);

                    var i;
                                        SRTlib.send("]},");

                    return Pe(function () {
                                            SRTlib.send(`{ "anonymous": true, "function": "call.xe.ReturnStatement.r.value.ReturnStatement.Se.i.map.ReturnStatement.Pe", "fileName": "${__filename}", "paramsNumber": 0, "calls" : [`);

                                            SRTlib.send("]},");

                      return e.options.silentErrors ? (n = (function (e, t) {
                                                SRTlib.send(`{ "anonymous": true, "function": "call.xe.ReturnStatement.r.value.ReturnStatement.Se.i.map.ReturnStatement.Pe.ReturnStatement", "fileName": "${__filename}", "paramsNumber": 2, "calls" : [`);
                        ...
                        return n && n.then ? n.then(void 0, t) : n;
                                                ...
                                                SRTlib.send(`{ "anonymous": true, "function": "call.xe.ReturnStatement.r.value.ReturnStatement.Se.i.map.ReturnStatement.Pe.ReturnStatement2", "fileName": "${__filename}", "paramsNumber": 0, "calls" : [`);

                                                SRTlib.send("]},");

                        return Se(t.parse(), function (e) {
                                                    SRTlib.send(`{ "anonymous": true, "function": "call.xe.ReturnStatement.r.value.ReturnStatement.Se.i.map.ReturnStatement.Pe.ReturnStatement.ReturnStatement.Se", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
                          ...
                          i = e;
                                                ...
                                                SRTlib.send(`{ "anonymous": true, "function": "call.xe.ReturnStatement.r.value.ReturnStatement.Se.i.map.ReturnStatement.Pe.ReturnStatement3", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);

                        r.push(e);
                                                SRTlib.send("]},");

                      }), s = function () {
                                                SRTlib.send(`{ "anonymous": true, "function": "call.xe.ReturnStatement.r.value.ReturnStatement.Se.i.map.ReturnStatement.Pe.ReturnStatement4", "fileName": "${__filename}", "paramsNumber": 0, "calls" : [`);

                        t.errors.length && r.push.apply(r, t.errors);
                                                SRTlib.send("]},");

                      }, n && n.then ? n.then(s) : s(n)) : Se(t.parse(), function (e) {
                                                SRTlib.send(`{ "anonymous": true, "function": "call.xe.ReturnStatement.r.value.ReturnStatement.Se.i.map.ReturnStatement.Pe.ReturnStatement.Se", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
                      ...
                      var n, s;
                                            ...
                                            SRTlib.send(`{ "anonymous": true, "function": "call.xe.ReturnStatement.r.value.ReturnStatement.Se.i.map.ReturnStatement.Pe2", "fileName": "${__filename}", "paramsNumber": 0, "calls" : [`);
                      ...
                      t.assignToOutput(n, i);
                                        ...
                                        SRTlib.send(`{ "anonymous": true, "function": "call.xe.ReturnStatement.r.value.ReturnStatement.Se.i.map2", "fileName": "${__filename}", "paramsNumber": 0, "calls" : [`);
            ...
            value: function (e, t) {
              ...
              if (r.length > 0) {
                (e = Math.min.apply(Math, [e].concat(r.map(function (e) {
                                    SRTlib.send(`{ "anonymous": true, "function": "call.Xe.ReturnStatement.r.value.Math.min.apply.concat", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
                  ...
                  return e.offset;
                                    ...
                                    SRTlib.send(`{ "anonymous": true, "function": "call.Xe.ReturnStatement.r.value.Math.max.apply.concat", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
            ...
            value: function (e) {
              ...
              try {
                ...
                return (n = this.readChunk(e, t), r = function (e) {
                                    SRTlib.send(`{ "anonymous": true, "function": "call.qe.ReturnStatement.r.value.ReturnStatement", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
        ...
        var Qe = (function () {
          ...
          function e(n, r, s) {
            ...
            (t(this, e), i(this, "ensureSegmentChunk", (a = function (e) {
              ...
              return (t = function () {
                                SRTlib.send(`{ "anonymous": true, "function": "i.ReturnStatement", "fileName": "${__filename}", "paramsNumber": 0, "calls" : [`);

                if (u.file.chunked) {
                                    SRTlib.send("]},");

                  return (function () {
                                        SRTlib.send(`{ "anonymous": true, "function": "i.ReturnStatement.ReturnStatement", "fileName": "${__filename}", "paramsNumber": 0, "calls" : [`);

                    if (!u.file.available(i, s)) {
                                            SRTlib.send("]},");

                      return (function (e, t) {
                                                SRTlib.send(`{ "anonymous": true, "function": "i.ReturnStatement.ReturnStatement.ReturnStatement", "fileName": "${__filename}", "paramsNumber": 2, "calls" : [`);
                        ...
                        return n && n.then ? n.then(void 0, t) : n;
                                                ...
                                                SRTlib.send(`{ "anonymous": true, "function": "i.ReturnStatement.ReturnStatement.ReturnStatement2", "fileName": "${__filename}", "paramsNumber": 0, "calls" : [`);

                                                SRTlib.send("]},");

                        return (t = u.file.readChunk(i, s), n = function (t) {
                                                    SRTlib.send(`{ "anonymous": true, "function": "i.ReturnStatement.ReturnStatement.ReturnStatement.ReturnStatement", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
                        ...
                        var t, n, r;
                                                ...
                                                SRTlib.send(`{ "anonymous": true, "function": "i.ReturnStatement.ReturnStatement.ReturnStatement3", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
                ...
                if (u.file.byteLength > i + s) e.chunk = u.file.subarray(i, s); else {
                  if (void 0 !== e.size) throw T("Segment unreachable: " + JSON.stringify(e));
                  e.chunk = u.file.subarray(i);
                }
                                SRTlib.send("]},");

              }, n = function (t) {
                                SRTlib.send(`{ "anonymous": true, "function": "i.ReturnStatement2", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
          ...
          function e(n) {
            ...
            (t(this, e), i(this, "errors", []), i(this, "raw", O()), i(this, "handleError", function (e) {
                            SRTlib.send(`{ "anonymous": true, "function": "i3", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
        ...
        var ct = (function (e) {
          ...
          return (s(n, e), r(n, [{
            ...
            value: function (e) {
                            SRTlib.send(`{ "anonymous": true, "function": "call.ct.ReturnStatement.r.value4", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);

              var t = this;
              (!0 === e ? (this.findAll = !0, this.wanted = A(R.keyList())) : (e = void 0 === e ? R.keyList().filter(function (e) {
                                SRTlib.send(`{ "anonymous": true, "function": "call.ct.ReturnStatement.r.value.filter", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
            ...
            key: "findAppSegments",
            value: function () {
                            SRTlib.send(`{ "anonymous": true, "function": "call.ct.ReturnStatement.r.value5", "fileName": "${__filename}", "paramsNumber": 0, "calls" : [`);
                ...
                return rt(function () {
                  ...
                  if (!i && n.file.chunked) {
                    ...
                    return (i = k(s).some(function (e) {
                                            SRTlib.send(`{ "anonymous": true, "function": "call.ct.ReturnStatement.r.value.ReturnStatement.rt.ReturnStatement.some", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
            ...
            value: function (e, t) {
                            SRTlib.send(`{ "anonymous": true, "function": "call.ct.ReturnStatement.r.value6", "fileName": "${__filename}", "paramsNumber": 2, "calls" : [`);
            ...
            key: "createParsers",
            value: function () {
                            SRTlib.send(`{ "anonymous": true, "function": "call.ct.ReturnStatement.r.value8", "fileName": "${__filename}", "paramsNumber": 0, "calls" : [`);
            ...
            value: function (e) {
                            SRTlib.send(`{ "anonymous": true, "function": "call.ct.ReturnStatement.r.value10", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
          ...
          return (s(n, e), r(n, [{
            ...
            value: function () {
              ...
              try {
                ...
                if ((e.findIfd0Offset(), e.ifd0Offset < 8)) throw T("Invalid EXIF data: IFD0 offset should be less than 8");
                if (!e.file.chunked && e.ifd0Offset > e.file.byteLength) throw T(("IFD0 offset points to outside of file.\nthis.ifd0Offset: ").concat(e.ifd0Offset, ", file.byteLength: ").concat(e.file.byteLength));
                                SRTlib.send("]},");
          ...
          return (s(n, e), r(n, [{
            ...
            value: function () {
              ...
              if (18761 === e) this.le = !0; else {
                if (19789 !== e) throw T("Invalid EXIF data: expected byte order marker (0x4949 or 0x4D4D).");
                this.le = !1;
              }
              if ((this.chunk.le = this.le, 42 !== this.chunk.getUint16(2))) throw T("Invalid EXIF data: expected 0x002A.");
              this.headerParsed = !0;
                            SRTlib.send("]},");
            ...
            value: function (e, t, n) {
              ...
              if ((a * s <= 4 ? e += 8 : e = this.chunk.getUint32(e + 8), i < 1 || i > 13)) throw T(("Invalid TIFF value type. block: ").concat(n.toUpperCase(), ", tag: ").concat(t.toString(16), ", type: ").concat(i, ", offset ").concat(e));
              if (e > this.chunk.byteLength) throw T(("Invalid TIFF value offset. block: ").concat(n.toUpperCase(), ", tag: ").concat(t.toString(16), ", type: ").concat(i, ", offset ").concat(e, " is outside of chunk size ").concat(this.chunk.byteLength));
              if (1 === i) {
                                SRTlib.send("]},");
              ...
              if (2 === i) {
                ...
                return "" === (r = (function (e) {
                                    SRTlib.send(`{ "anonymous": true, "function": "call.yt.ReturnStatement.r.value.ReturnStatement.trim", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
  ...
  31: [function (require, module, exports) {
    ...
    function _extends() {
      ...
      _extends = Object.assign || (function (target) {
                SRTlib.send(`{ "anonymous": true, "function": "emptyKey44", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
      ...
      _proto.interpolate = function interpolate(phrase, options) {
        ...
        function insertReplacement(source, rx, replacement) {
          ...
          source.forEach(function (chunk) {
                        SRTlib.send(`{ "anonymous": true, "function": "emptyKey46", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
  ...
  44: [function (require, module, exports) {
    ...
    uppyThumbnails.on('file-added', function (file) {
            SRTlib.send(`{ "anonymous": true, "function": "emptyKey60", "fileName": "${__filename}", "paramsNumber": 1, "calls" : [`);
    ...
    uppyThumbnails.on('thumbnail:error', function (file, err) {
            SRTlib.send(`{ "anonymous": true, "function": "emptyKey61", "fileName": "${__filename}", "paramsNumber": 2, "calls" : [`);
    ...
    uppyThumbnails.on('thumbnail:generated', function (file, preview) {
            SRTlib.send(`{ "anonymous": true, "function": "emptyKey62", "fileName": "${__filename}", "paramsNumber": 2, "calls" : [`);
