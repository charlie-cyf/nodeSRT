...
describe.skip('XHRUpload with `limit`', () => {
  ...
  it('should start counting progress for all files', async () => {
    const files = [makeFile(1000), makeFile(1000), makeFile(1000), makeFile(1000), makeFile(1000), makeFile(1000), makeFile(1000), makeFile(1000), makeFile(1000), makeFile(1000)];
