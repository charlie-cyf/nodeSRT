      ...
      function Translator(locales) {
        ...
        if (Array.isArray(locales)) {
          locales.forEach(function (locale) {
                        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"emptyKey42","fileName":"${__filename}","paramsNumber":1},`);
      ...
      _proto.interpolate = function interpolate(phrase, options) {
        ...
        function insertReplacement(source, rx, replacement) {
          ...
          source.forEach(function (chunk) {
                        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"emptyKey43","fileName":"${__filename}","paramsNumber":1},`);
  ...
  51: [function (require, module, exports) {
    ...
    function startXHRLimitTest(endpoint) {
      ...
      uppy.on('upload-started', function () {
                SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"emptyKey60","fileName":"${__filename}","paramsNumber":0},`);
      ...
      uppy.on('upload-success', function () {
                SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"emptyKey61","fileName":"${__filename}","paramsNumber":0},`);
