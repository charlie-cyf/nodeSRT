...
var ALLOWED_COMPANION_PATTERN = /undefined/undefined; // Regex used to check if a Companion address is run by Transloadit.

var TL_COMPANION = /undefined/undefined;
var TL_UPPY_SERVER = /undefined/undefined;
/**
...
module.exports = (_temp = _class = /*#__PURE__*/function (_Plugin) {
  ...
  _proto._attachAssemblyMetadata = function _attachAssemblyMetadata(file, status) {
    ...
    if (file.remote && TL_COMPANION.test(file.remote.companionUrl)) {
      var newHost = status.companion_url.replace(/undefined/undefined, "");
      var path = file.remote.url.replace(file.remote.companionUrl, "").replace(/undefined/undefined, "");
  ...
  _proto._createAssemblyWatcher = function _createAssemblyWatcher(assemblyID, fileIDs, uploadID) {
    ...
    var _this4 = this; // AssemblyWatcher tracks completion states of all Assemblies in this upload.
  ...
  _proto._prepareUpload = function _prepareUpload(fileIDs, uploadID) {
    ...
    var _this12 = this,
        _extends7; // Only use files without errors
