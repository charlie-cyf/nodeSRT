...
function validateParams(params) {
  SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"validateParams","fileName":"/src/AssemblyOptions.js","paramsNumber":1},`);
...
class AssemblyOptions {
  constructor(files, opts) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"constructor","fileName":"/src/AssemblyOptions.js","paramsNumber":2,"classInfo":{"className":"AssemblyOptions"}},`);
    this.files = files;
    this.opts = opts;
  ...
  _normalizeAssemblyOptions(file, assemblyOptions) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"_normalizeAssemblyOptions","fileName":"/src/AssemblyOptions.js","paramsNumber":2,"classInfo":{"className":"AssemblyOptions"}},`);

    if (Array.isArray(assemblyOptions.fields)) {
      const fieldNames = assemblyOptions.fields;
      assemblyOptions.fields = {};
      fieldNames.forEach(fieldName => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"fieldNames.forEach","fileName":"/src/AssemblyOptions.js","paramsNumber":1},`);
  ...
  _getAssemblyOptions(file) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"_getAssemblyOptions","fileName":"/src/AssemblyOptions.js","paramsNumber":1,"classInfo":{"className":"AssemblyOptions"}},`);
    const options = this.opts;
    SRTlib.send("{\"type\":\"FUNCTIONEND\",\"function\":\"_getAssemblyOptions\"},");
    return Promise.resolve().then(() => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"ReturnStatement.Promise.resolve.then.then.then.Promise.resolve.then.then.Promise.resolve.then","fileName":"/src/AssemblyOptions.js","paramsNumber":0},`);
      ...
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"ReturnStatement.Promise.resolve.then.then.then.Promise.resolve.then.then","fileName":"/src/AssemblyOptions.js","paramsNumber":1},`);
      ...
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"ReturnStatement.Promise.resolve.then.then.then","fileName":"/src/AssemblyOptions.js","paramsNumber":1},`);
  ...
  _dedupe(list) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"_dedupe","fileName":"/src/AssemblyOptions.js","paramsNumber":1,"classInfo":{"className":"AssemblyOptions"}},`);
    const dedupeMap = Object.create(null);
    list.forEach(({
      fileIDs,
      options
    }) => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"list.forEach","fileName":"/src/AssemblyOptions.js","paramsNumber":1},`);
    ...
    return Object.keys(dedupeMap).map(id => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"ReturnStatement.Object.keys.map","fileName":"/src/AssemblyOptions.js","paramsNumber":1},`);
  ...
  build() {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"build","fileName":"/src/AssemblyOptions.js","paramsNumber":0,"classInfo":{"className":"AssemblyOptions"}},`);
    const options = this.opts;

    if (this.files.length > 0) {
      SRTlib.send("{\"type\":\"FUNCTIONEND\",\"function\":\"build\"},");
      return Promise.all(this.files.map(file => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"ReturnStatement.Promise.all.then.Promise.all.files.map","fileName":"/src/AssemblyOptions.js","paramsNumber":1},`);
        ...
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"ReturnStatement.Promise.all.then","fileName":"/src/AssemblyOptions.js","paramsNumber":1},`);
    ...
    if (options.alwaysRunAssembly) {
      ...
      return Promise.resolve(options.getAssemblyOptions(null, options)).then(assemblyOptions => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"ReturnStatement.Promise.resolve.then","fileName":"/src/AssemblyOptions.js","paramsNumber":1},`);
        validateParams(assemblyOptions.params);
        SRTlib.send("{\"type\":\"FUNCTIONEND\",\"function\":\"ReturnStatement.Promise.resolve.then\"},");
        return [{
          fileIDs: this.files.map(file => {
            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"ReturnStatement.fileIDs.files.map","fileName":"/src/AssemblyOptions.js","paramsNumber":1},`);
