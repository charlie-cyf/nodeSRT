...
function defaultGetAssemblyOptions(file, options) {
  SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"defaultGetAssemblyOptions","fileName":"/src/index.js","paramsNumber":2},`);
...
const ALLOWED_COMPANION_PATTERN = /undefined/undefined; // Regex used to check if a Companion address is run by Transloadit.

const TL_COMPANION = /undefined/undefined;
const TL_UPPY_SERVER = /undefined/undefined;
/**
...
module.exports = class Transloadit extends Plugin {
  ...
  constructor(uppy, opts) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"constructor","fileName":"/src/index.js","paramsNumber":2,"classInfo":{"className":"Transloadit","superClass":"Plugin"}},`);
    super(uppy, opts);
    this.type = "uploader";
    ...
    this.assemblyWatchers = {}; // Contains a file IDs that have completed postprocessing before the upload they belong to has entered the postprocess stage.
  ...
  setOptions(newOpts) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"setOptions","fileName":"/src/index.js","paramsNumber":1,"classInfo":{"className":"Transloadit","superClass":"Plugin"}},`);
  ...
  i18nInit() {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"i18nInit","fileName":"/src/index.js","paramsNumber":0,"classInfo":{"className":"Transloadit","superClass":"Plugin"}},`);
  ...
  _getClientVersion() {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"_getClientVersion","fileName":"/src/index.js","paramsNumber":0,"classInfo":{"className":"Transloadit","superClass":"Plugin"}},`);
    ...
    const addPluginVersion = (pluginName, versionName) => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"addPluginVersion","fileName":"/src/index.js","paramsNumber":2},`);
  ...
  _attachAssemblyMetadata(file, status) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"_attachAssemblyMetadata","fileName":"/src/index.js","paramsNumber":2,"classInfo":{"className":"Transloadit","superClass":"Plugin"}},`);
    ...
    if (file.remote && TL_UPPY_SERVER.test(file.remote.companionUrl)) {
      const err = new Error("The https://api2.transloadit.com/uppy-server endpoint was renamed to " + "https://api2.transloadit.com/companion, please update your `companionUrl` " + "options accordingly."); // Explicitly log this error here because it is caught by the `createAssembly`
    ...
    if (file.remote && TL_COMPANION.test(file.remote.companionUrl)) {
      const newHost = status.companion_url.replace(/undefined/undefined, "");
      const path = file.remote.url.replace(file.remote.companionUrl, "").replace(/undefined/undefined, "");
      remote = { ...file.remote,
  ...
  _createAssembly(fileIDs, uploadID, options) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"_createAssembly","fileName":"/src/index.js","paramsNumber":3,"classInfo":{"className":"Transloadit","superClass":"Plugin"}},`);
    ...
    return this.client.createAssembly({
      ...
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.ReturnStatement.client.createAssembly.then.catch.client.createAssembly.then","fileName":"/src/index.js","paramsNumber":1},`);
      ...
      const updatedFiles = {};
      fileIDs.forEach(id => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"fileIDs.forEach","fileName":"/src/index.js","paramsNumber":1},`);
      ...
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.ReturnStatement.client.createAssembly.then.catch","fileName":"/src/index.js","paramsNumber":1},`);
      err.message = `${this.i18n("creatingAssemblyFailed")}: ${err.message}`; // Reject the promise.
  ...
  _createAssemblyWatcher(assemblyID, fileIDs, uploadID) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"_createAssemblyWatcher","fileName":"/src/index.js","paramsNumber":3,"classInfo":{"className":"Transloadit","superClass":"Plugin"}},`);
    // AssemblyWatcher tracks completion states of all Assemblies in this upload.
    const watcher = new AssemblyWatcher(this.uppy, assemblyID);
    watcher.on("assembly-complete", id => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.watcher.on","fileName":"/src/index.js","paramsNumber":1},`);
      const files = this.getAssemblyFiles(id);
      files.forEach(file => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"files.forEach","fileName":"/src/index.js","paramsNumber":1},`);
    ...
    watcher.on("assembly-error", (id, error) => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.watcher.on###2","fileName":"/src/index.js","paramsNumber":2},`);
      // Clear postprocessing state for all our files.
      const files = this.getAssemblyFiles(id);
      files.forEach(file => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"files.forEach###2","fileName":"/src/index.js","paramsNumber":1},`);
  ...
  _shouldWaitAfterUpload() {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"_shouldWaitAfterUpload","fileName":"/src/index.js","paramsNumber":0,"classInfo":{"className":"Transloadit","superClass":"Plugin"}},`);
  ...
  _reserveFiles(assembly, fileIDs) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"_reserveFiles","fileName":"/src/index.js","paramsNumber":2,"classInfo":{"className":"Transloadit","superClass":"Plugin"}},`);
    SRTlib.send("{\"type\":\"FUNCTIONEND\",\"function\":\"_reserveFiles\"},");
    return Promise.all(fileIDs.map(fileID => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.ReturnStatement.Promise.all.fileIDs.map","fileName":"/src/index.js","paramsNumber":1},`);
  ...
  _onFileUploadURLAvailable(file) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"_onFileUploadURLAvailable","fileName":"/src/index.js","paramsNumber":1,"classInfo":{"className":"Transloadit","superClass":"Plugin"}},`);
    ...
    this.client.addFile(assembly, file).catch(err => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.client.addFile.catch","fileName":"/src/index.js","paramsNumber":1},`);
      this.uppy.log(err);
  ...
  _findFile(uploadedFile) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"_findFile","fileName":"/src/index.js","paramsNumber":1,"classInfo":{"className":"Transloadit","superClass":"Plugin"}},`);
  ...
  _onFileUploadComplete(assemblyId, uploadedFile) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"_onFileUploadComplete","fileName":"/src/index.js","paramsNumber":2,"classInfo":{"className":"Transloadit","superClass":"Plugin"}},`);
  ...
  _onResult(assemblyId, stepName, result) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"_onResult","fileName":"/src/index.js","paramsNumber":3,"classInfo":{"className":"Transloadit","superClass":"Plugin"}},`);
    const state = this.getPluginState();
  ...
  _onAssemblyFinished(status) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"_onAssemblyFinished","fileName":"/src/index.js","paramsNumber":1,"classInfo":{"className":"Transloadit","superClass":"Plugin"}},`);
    const url = status.assembly_ssl_url;
    this.client.getAssemblyStatus(url).then(finalStatus => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.client.getAssemblyStatus.then","fileName":"/src/index.js","paramsNumber":1},`);
  ...
  _cancelAssembly(assembly) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"_cancelAssembly","fileName":"/src/index.js","paramsNumber":1,"classInfo":{"className":"Transloadit","superClass":"Plugin"}},`);
    SRTlib.send("{\"type\":\"FUNCTIONEND\",\"function\":\"_cancelAssembly\"},");
    return this.client.cancelAssembly(assembly).then(() => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.ReturnStatement.client.cancelAssembly.then","fileName":"/src/index.js","paramsNumber":0},`);
  ...
  _onCancelAll() {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"_onCancelAll","fileName":"/src/index.js","paramsNumber":0,"classInfo":{"className":"Transloadit","superClass":"Plugin"}},`);
    const {
      uploadsAssemblies
    } = this.getPluginState();
    const assemblyIDs = Object.keys(uploadsAssemblies).reduce((acc, uploadID) => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.assemblyIDs.Object.keys.reduce","fileName":"/src/index.js","paramsNumber":2},`);
    ...
    const cancelPromises = assemblyIDs.map(assemblyID => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.cancelPromises.assemblyIDs.map","fileName":"/src/index.js","paramsNumber":1},`);
    ...
    Promise.all(cancelPromises).catch(err => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.Promise.all.catch","fileName":"/src/index.js","paramsNumber":1},`);
      this.uppy.log(err);
  ...
  _getPersistentData(setData) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"_getPersistentData","fileName":"/src/index.js","paramsNumber":1,"classInfo":{"className":"Transloadit","superClass":"Plugin"}},`);
    const state = this.getPluginState();
  ...
  _onRestored(pluginData) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"_onRestored","fileName":"/src/index.js","paramsNumber":1,"classInfo":{"className":"Transloadit","superClass":"Plugin"}},`);
    ...
    const restoreState = assemblies => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"restoreState","fileName":"/src/index.js","paramsNumber":1},`);
      const files = {};
      const results = [];
      Object.keys(assemblies).forEach(id => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"Object.keys.forEach###2","fileName":"/src/index.js","paramsNumber":1},`);
        const status = assemblies[id];
        status.uploads.forEach(uploadedFile => {
          SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"status.uploads.forEach","fileName":"/src/index.js","paramsNumber":1},`);
        ...
        Object.keys(status.results).forEach(stepName => {
          SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"Object.keys.forEach","fileName":"/src/index.js","paramsNumber":1},`);
          status.results[stepName].forEach(result => {
            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"status.results.stepName.forEach","fileName":"/src/index.js","paramsNumber":1},`);
    ...
    const restoreAssemblies = () => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"restoreAssemblies","fileName":"/src/index.js","paramsNumber":0},`);
      const {
        assemblies,
        uploadsAssemblies
      ...
      Object.keys(uploadsAssemblies).forEach(uploadID => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"Object.keys.forEach###3","fileName":"/src/index.js","paramsNumber":1},`);
        const assemblyIDs = uploadsAssemblies[uploadID];
        const fileIDsInUpload = assemblyIDs.reduce((acc, assemblyID) => {
          SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"fileIDsInUpload.assemblyIDs.reduce","fileName":"/src/index.js","paramsNumber":2},`);
          const fileIDsInAssembly = this.getAssemblyFiles(assemblyID).map(file => {
            SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"fileIDsInAssembly.getAssemblyFiles.map","fileName":"/src/index.js","paramsNumber":1},`);
      ...
      allAssemblyIDs.forEach(id => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"allAssemblyIDs.forEach","fileName":"/src/index.js","paramsNumber":1},`);
    ...
    const updateAssemblies = () => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"updateAssemblies","fileName":"/src/index.js","paramsNumber":0},`);
      const {
        assemblies
      } = this.getPluginState();
      ...
      return Promise.all(Object.keys(assemblies).map(id => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"ReturnStatement.Promise.all.Object.keys.map","fileName":"/src/index.js","paramsNumber":1},`);
    ...
    this.restored = Promise.resolve().then(() => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.restored.Promise.resolve.then","fileName":"/src/index.js","paramsNumber":0},`);
    ...
    this.restored.then(() => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.restored.then","fileName":"/src/index.js","paramsNumber":0},`);
      this.restored = null;
  ...
  _connectAssembly(assembly) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"_connectAssembly","fileName":"/src/index.js","paramsNumber":1,"classInfo":{"className":"Transloadit","superClass":"Plugin"}},`);
    const {
      status
    } = assembly;
    ...
    assembly.on("status", newStatus => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.assembly.on","fileName":"/src/index.js","paramsNumber":1},`);
      const {
        assemblies
      } = this.getPluginState();
      this.setPluginState({
    ...
    assembly.on("upload", file => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.assembly.on###2","fileName":"/src/index.js","paramsNumber":1},`);
    ...
    assembly.on("error", error => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.assembly.on###3","fileName":"/src/index.js","paramsNumber":1},`);
    ...
    assembly.on("executing", () => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.assembly.on###4","fileName":"/src/index.js","paramsNumber":0},`);
    ...
    if (this.opts.waitForEncoding) {
      assembly.on("result", (stepName, result) => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.assembly.on###5","fileName":"/src/index.js","paramsNumber":2},`);
    ...
    if (this.opts.waitForEncoding) {
      assembly.on("finished", () => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.assembly.on###6","fileName":"/src/index.js","paramsNumber":0},`);
      ...
      assembly.on("metadata", () => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.assembly.on###7","fileName":"/src/index.js","paramsNumber":0},`);
    ...
    const connected = new Promise((resolve, reject) => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.connected.then.NewExpression","fileName":"/src/index.js","paramsNumber":2},`);
      ...
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.connected.then","fileName":"/src/index.js","paramsNumber":0},`);
  ...
  _prepareUpload(fileIDs, uploadID) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"_prepareUpload","fileName":"/src/index.js","paramsNumber":2,"classInfo":{"className":"Transloadit","superClass":"Plugin"}},`);
    // Only use files without errors
    fileIDs = fileIDs.filter(file => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.fileIDs.fileIDs.filter","fileName":"/src/index.js","paramsNumber":1},`);
    ...
    fileIDs.forEach(fileID => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.fileIDs.forEach","fileName":"/src/index.js","paramsNumber":1},`);
      const file = this.uppy.getFile(fileID);
    ...
    const createAssembly = ({
      ...
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"createAssembly","fileName":"/src/index.js","paramsNumber":1},`);
      let createdAssembly;
      SRTlib.send("{\"type\":\"FUNCTIONEND\",\"function\":\"createAssembly\"},");
      SRTlib.send("{\"type\":\"FUNCTIONEND\",\"function\":\"_prepareUpload\"},");
      return this._createAssembly(fileIDs, uploadID, options).then(assembly => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"ReturnStatement._createAssembly.then.then.catch._createAssembly.then.then._createAssembly.then","fileName":"/src/index.js","paramsNumber":1},`);
        ...
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"ReturnStatement._createAssembly.then.then.catch._createAssembly.then.then","fileName":"/src/index.js","paramsNumber":0},`);
        fileIDs.forEach(fileID => {
          SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"fileIDs.forEach###2","fileName":"/src/index.js","paramsNumber":1},`);
          const file = this.uppy.getFile(fileID);
        ...
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"ReturnStatement._createAssembly.then.then.catch","fileName":"/src/index.js","paramsNumber":1},`);
        fileIDs.forEach(fileID => {
          SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"fileIDs.forEach###3","fileName":"/src/index.js","paramsNumber":1},`);
    ...
    const files = fileIDs.map(id => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.files.fileIDs.map","fileName":"/src/index.js","paramsNumber":1},`);
    ...
    return assemblyOptions.build().then(assemblies => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.ReturnStatement.assemblyOptions.build.then","fileName":"/src/index.js","paramsNumber":1},`);
      ...
      return Promise.all(assemblies.map(createAssembly)).then(createdAssemblies => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"Promise.all.then","fileName":"/src/index.js","paramsNumber":1},`);
        const assemblyIDs = createdAssemblies.map(assembly => {
          SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"assemblyIDs.createdAssemblies.map","fileName":"/src/index.js","paramsNumber":1},`);
        ...
        createdAssemblies.map(assembly => {
          SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"createdAssemblies.map","fileName":"/src/index.js","paramsNumber":1},`);
    ...
    err => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.ReturnStatement.assemblyOptions.build.then###2","fileName":"/src/index.js","paramsNumber":1},`);
      fileIDs.forEach(fileID => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"fileIDs.forEach###4","fileName":"/src/index.js","paramsNumber":1},`);
        const file = this.uppy.getFile(fileID);
        this.uppy.emit("preprocess-complete", file);
        this.uppy.emit("upload-error", file, err);
  ...
  _afterUpload(fileIDs, uploadID) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"_afterUpload","fileName":"/src/index.js","paramsNumber":2,"classInfo":{"className":"Transloadit","superClass":"Plugin"}},`);
    const files = fileIDs.map(fileID => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.files.fileIDs.map###2","fileName":"/src/index.js","paramsNumber":1},`);
    ...
    fileIDs = files.filter(file => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.fileIDs.files.filter.map.files.filter","fileName":"/src/index.js","paramsNumber":1},`);
      SRTlib.send("{\"type\":\"FUNCTIONEND\",\"function\":\"module.exports.fileIDs.files.filter.map.files.filter\"},");
      SRTlib.send("{\"type\":\"FUNCTIONEND\",\"function\":\"_afterUpload\"},");
      return !file.error;
      SRTlib.send("{\"type\":\"FUNCTIONEND\",\"function\":\"module.exports.fileIDs.files.filter.map.files.filter\"},");
    }).map(file => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.fileIDs.files.filter.map","fileName":"/src/index.js","paramsNumber":1},`);
    ...
    if (this.restored) {
      ...
      return this.restored.then(() => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.ReturnStatement.restored.then","fileName":"/src/index.js","paramsNumber":0},`);
    ...
    const assemblyIDs = state.uploadsAssemblies[uploadID]; // If we don't have to wait for encoding metadata or results, we can close
    // the socket immediately and finish the upload.

    if (!this._shouldWaitAfterUpload()) {
      assemblyIDs.forEach(assemblyID => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.assemblyIDs.forEach","fileName":"/src/index.js","paramsNumber":1},`);
      ...
      const assemblies = assemblyIDs.map(id => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.assemblies.assemblyIDs.map","fileName":"/src/index.js","paramsNumber":1},`);
    ...
    const incompleteFiles = files.filter(file => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.incompleteFiles.files.filter","fileName":"/src/index.js","paramsNumber":1},`);
    ...
    incompleteFiles.forEach(file => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.incompleteFiles.forEach","fileName":"/src/index.js","paramsNumber":1},`);
    ...
    return watcher.promise.then(() => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.ReturnStatement.watcher.promise.then","fileName":"/src/index.js","paramsNumber":0},`);
      const assemblies = assemblyIDs.map(id => {
        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"assemblies.assemblyIDs.map","fileName":"/src/index.js","paramsNumber":1},`);
  ...
  _onError(err = null, uploadID) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"_onError","fileName":"/src/index.js","paramsNumber":2,"classInfo":{"className":"Transloadit","superClass":"Plugin"}},`);
    const state = this.getPluginState();
    const assemblyIDs = state.uploadsAssemblies[uploadID];
    assemblyIDs.forEach(assemblyID => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.assemblyIDs.forEach###2","fileName":"/src/index.js","paramsNumber":1},`);
  ...
  _onTusError(err) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"_onTusError","fileName":"/src/index.js","paramsNumber":1,"classInfo":{"className":"Transloadit","superClass":"Plugin"}},`);

    if (err && /undefined/undefined.test(err.message)) {
      const xhr = err.originalRequest ? err.originalRequest.getUnderlyingObject() : null;
      const url = xhr && xhr.responseURL ? xhr.responseURL : null;
      this.client.submitError(err, {
        url,
        type: "TUS_ERROR"
      }).then(_ => {// if we can't report the error that sucks

        SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.client.submitError.then","fileName":"/src/index.js","paramsNumber":1},`);
  ...
  install() {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"install","fileName":"/src/index.js","paramsNumber":0,"classInfo":{"className":"Transloadit","superClass":"Plugin"}},`);
  ...
  uninstall() {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"uninstall","fileName":"/src/index.js","paramsNumber":0,"classInfo":{"className":"Transloadit","superClass":"Plugin"}},`);
  ...
  getAssembly(id) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"getAssembly","fileName":"/src/index.js","paramsNumber":1,"classInfo":{"className":"Transloadit","superClass":"Plugin"}},`);
    const {
      assemblies
    } = this.getPluginState();
  ...
  getAssemblyFiles(assemblyID) {
    SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":false,"function":"getAssemblyFiles","fileName":"/src/index.js","paramsNumber":1,"classInfo":{"className":"Transloadit","superClass":"Plugin"}},`);
    SRTlib.send("{\"type\":\"FUNCTIONEND\",\"function\":\"getAssemblyFiles\"},");
    return this.uppy.getFiles().filter(file => {
      SRTlib.send(`{"type":"FUNCTIONSTART","anonymous":true,"function":"module.exports.ReturnStatement.uppy.getFiles.filter","fileName":"/src/index.js","paramsNumber":1},`);
