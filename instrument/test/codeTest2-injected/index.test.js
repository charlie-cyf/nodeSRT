  ...
  ['http://localhost:7080', 'https://www.test.bbc.com', 'https://www.bbc.com'].forEach(baseUrl => {
    describe(`with base url ${baseUrl}`, () => {
      ...
      it('should return amp url', () => {
        SRTlib.send(`{"type":"TESTSTART","testName":"should%20return%20amp%20url","fileName":"/index.test.js"},`);
        expect(getAmpUrl(`${baseUrl}/pathname`)).toEqual(`${baseUrl}/pathname.amp`);
      });
      it('should not append .amp to amp path', () => {
        SRTlib.send(`{"type":"TESTSTART","testName":"should%20not%20append%20.amp%20to%20amp%20path","fileName":"/index.test.js"},`);
      ...
      it('should return amp url for path with query string params', () => {
        SRTlib.send(`{"type":"TESTSTART","testName":"should%20return%20amp%20url%20for%20path%20with%20query%20string%20params","fileName":"/index.test.js"},`);
      ...
      it('should not append .amp to amp path with query string params', () => {
        SRTlib.send(`{"type":"TESTSTART","testName":"should%20not%20append%20.amp%20to%20amp%20path%20with%20query%20string%20params","fileName":"/index.test.js"},`);
